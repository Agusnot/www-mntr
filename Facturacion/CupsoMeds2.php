...
<script language="javascript">
	...
	function Cups()
	{
		...
		parent.frames.FrameOpener.location.href="NewFactura2.php?DatNameSID=<? echo $DatNameSID?>&TMPCOD=<? echo $TMPCOD?>&Tipo=Cup&Entidad=<? echo $Entidad?>&Contrato=<? echo $Contrato?>&NoContrato=<? echo $NoContrato?>&FechFin=<? echo $FechFin?>&FechIni=<? echo $FechIni?>&CedPac=<? echo $Cedula?>&NumServ=<? echo $NumServ?>";
		parent.document.getElementById('FrameOpener').style.position='absolute';
	...
	{
		st = parent.document.body.scrollTop;
		parent.frames.FrameOpener.location.href="NewFactura2.php?DatNameSID=<? echo $DatNameSID?>&TMPCOD=<? echo $TMPCOD?>&Tipo=Medicamentos&Entidad=<? echo $Entidad?>&Contrato=<? echo $Contrato?>&NoContrato=<? echo $NoContrato?>&FechFin=<? echo $FechFin?>&FechIni=<? echo $FechIni?>&CedPac=<? echo $Cedula?>&NumServ=<? echo $NumServ?>";
		parent.document.getElementById('FrameOpener').style.position='absolute';
		parent.document.getElementById('FrameOpener').style.top=30+st;
		parent.document.getElementById('FrameOpener').style.left=10;
		parent.document.getElementById('FrameOpener').style.display='';
