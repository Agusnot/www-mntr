	...
	var gotoString = "Vaya a Mes corriente"
	var todayString = "Hoy es"
	var weekString = "Sem"
	var scrollLeftMessage = "Use el scroll del mouse para mes previo"
	var scrollRightMessage = "Use el scroll del mouse para mes previo"
	var selectMonthMessage = "Clic pra seleccionar el mes"
	var selectYearMessage = "Clic para seleccionar el a&ntilde;o"
    ...
    */
	...
	if (dom)
	{
		...
		document.write ("<div onclick='bShow=true' id='calendar'	style='z-index:+999;position:absolute;visibility:hidden;'><table	width="+((showWeekNumber==1)?250:220)+" style='font-family:arial;font-size:11px;border-width:1;border-style:solid;border-color:#a0a0a0;font-family:arial; font-size:11px}' bgcolor='#ffffff'><tr background='../calendario/images/calback.jpg'><td background='../calendario/images/calback.jpg'><table width='"+((showWeekNumber==1)?248:218)+"'><tr><td style='padding:2px;font-family:arial; font-size:11px;'><font color='#000000'><B><span id='caption'></span></B></font></td><td align=right><a href='javascript:hideCalendar()'><IMG SRC='"+imgDir+"close.gif' BORDER='0' ALT='Cerrar el Calendario'></a></td></tr></table></td></tr><tr><td style='padding:5px' bgcolor=#ffffff><span id='content'></span></td></tr>")
...
//Dentro de el siguiente ciclo se generan los a&ntilde;os, en el caso de 
//que sea introcir fecha de nacimiento restale 30---- i>=(yearNow-30)
//CAMBIA el siguiente for por el original " for	(i=yearNow; i<=(yearNow+4); i++) { "
//si quieres que los a&ntilde;os empizen en el actual en adelante		
			for	(i=(yearNow+5); i>=(yearNow-20); i--) {		
				sName =	i;
				if (i==yearSelected){
					sName =	"<B>" +	sName +	"</B>"
				}
...
//------------------------------------TERMINAR LA FUNCION EN 0 PARA QUE INICIE EN EL DIA ACTUAL EN LA SIGUIENTE LINEA----------------------------------------------
	...
	function popUpCalendar(ctl,	ctl2, format,posx,posy) {
		if(posx==1){var leftpos=-150}
		else{var leftpos=10}
		if(posy==1){var toppos=-60}
		else{var toppos=-10}
		if (bPageLoaded)
		{
...
//------------------------------------TERMINAR LA FUNCION EN 0 PARA QUE INICIE EN EL DIA ACTUAL EN LA SIGUIENTE LINEA----------------------------------------------
			...
			{
				hideCalendar()
				if (ctlNow!=ctl) {popUpCalendar(ctl, ctl2, format,posx,posy)}
			}
			ctlNow = ctl
		}
...
//----------------------------Eliminar las siguientes lineas para activar todos los dias del a&ntilde;o-----y retornar un false-----------------------------------------
