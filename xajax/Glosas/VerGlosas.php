...
if($Ver){
	...
	<table BORDER=1  style='font : normal normal small-caps 12px Tahoma;' border="1" bordercolor="#e5e5e5" cellpadding="2" align="center">  
		...
		<tr align="center"  bgcolor="#e5e5e5" style="font-weight:bold">	
        	...
        	<td>No Factura</td><td>Fecha Factura</td><td>Fecha Radicacion</td><td>Entidad</td><td>Vr Factura</td><td>Vr Glosa</td>
       	<?	while($fila=ExFetch($res)){
				$Fec=explode(" ",$fila[1]);?>	
       			<tr onMouseOver="this.bgColor='#AAD4FF'" onMouseOut="this.bgColor=''">
                    ...
                    <?					
					$numf= $fila[0];				     
					$con4= "SELECT vrglosatotal FROM facturacion.respuestaglosa where nufactura='$numf'";					
					$res4= ExQuery($con4);
