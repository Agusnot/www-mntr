					...
					if(document.FORMA.FacF.value!=""){
						if(document.FORMA.FacI.value==""){
							...
							if(parseInt(document.FORMA.FacI.value)>parseInt(document.FORMA.FacF.value)){
								...
								frames.VerListVBGlosas.location.href='VerListVBGlosas.php?DatNameSID=<? echo $DatNameSID?>&Entidad=<? echo $Entidad?>&FechaIni='+document.FORMA.FechaIni.value+'&FechaFin='+document.FORMA.FechaFin.value+'&Contrato=<? echo $Contrato?>&NoContrato=<? echo $NoContrato?>&Ver=1&FacI='+document.FORMA.FacI.value+'&FacF='+document.FORMA.FacF.value;
							}
						}
					}
					else{									
...
?>
	<tr align="center">	
        <td colspan="8" bgcolor="#e5e5e5" style="font-weight:bold">Visto Bueno Glosa</td>
...
<iframe frameborder="0" id="VerListVBGlosas" src="VerListVBGlosas.php?DatNameSID=<? echo $DatNameSID?>&Entidad=<? echo $Entidad?>&FechaIni=<? echo $FechaIni?>&FechaFin=<? echo $FechaFin?>&Contrato=<? echo $Contrato?>&NoContrato=<? echo $NoContrato?>" width="100%" height="85%"></iframe>    
</body>
</html>
