<?
	...
	if($Guardar){
		if(!$Edit){
			...
			//echo $cons2;
			if(ExNumRows($res2)<=0){
	$cons="insert into facturacion.firmasrtaglosas (compania,usuario) values ('$Compania[0]','$UsuarioGlosa')";	
...
<table BORDER=1  style='font : normal normal small-caps 12px Tahoma;' border="1" bordercolor="#e5e5e5" cellpadding="2"> 
	<tr align="center"  bgcolor="#e5e5e5" style="font-weight:bold"><td>usuario</td>
    </tr>
    <tr align="center">
    	<td>        
        <?
