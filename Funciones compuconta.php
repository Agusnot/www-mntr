<?php
	...
	if($EnginneDef==2)
	   $conex = pg_connect("dbname=".$Data->getParameter("PARAM_DB")." user=".$Data->getParameter("PARAM_USER")." password=".$Data->getParameter("PARAM_PASS")."") or die ('no establecida');
