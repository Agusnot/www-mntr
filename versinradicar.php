...
<? if($Ver){?>
<iframe frameborder="0" id="VerLiquidado" src="verfacrad.php?DatNameSID=<? echo $DatNameSID?>&FechaIni=<? echo $FechaIni?>&FechaFin=<? echo $FechaFin?>&Entidad=<? echo $Entidad?>&Contrato=<? echo $Contrato?>&NoContrato=<? echo $NoContrato?>&Tipo=<? echo $Tipo?>" width="100%" height="85%">
</iframe>
<? }?>
</body>
</html>
