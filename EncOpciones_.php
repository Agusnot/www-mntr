...
<font size="2">
<br><span style="float:right; padding-right: 5px;">
    <?php echo strtoupper("$DiaSemana, $ND[mday] DE ".$Meses[$ND[mon]]." DE $ND[year]"." $Horas[0]:$ND[minutes] $Horas[1]");?>
</span>
<img src="/Imgs/User50x50.png" style="float:left; width: 15px; padding-left: 20px; padding-right: 5px;">USUARIO: <span style="color:#333333; font-weight: bolder; font-size: 13px;"><?php echo $usuario[0];?></span>
<br>
...
-->
<br>
<div style="z-index: -9; background-color: #75c7ec; width:105%; height: 50px; position: absolute; top: 0px; right: 0px;"></div>
<?php
	...
	if($Msj){?>
<marquee SCROLLDELAY="155"><strong><? echo $Msj?></strong></marquee>
<? }
?>
</font>
