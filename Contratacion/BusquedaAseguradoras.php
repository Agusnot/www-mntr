...
<?
	...
	{
		$cons = "Select Identificacion,Primape,Direccion,Telefono,Replegal from Central.Terceros where Tipo='Asegurador' and Compania = '$Compania[0]' and
		Identificacion ilike '$Identificacion%' and Primape ilike '$Nombre%' order by primape";				
		$res = ExQuery($cons);
		if(ExNumRows($res)>0)
		{
