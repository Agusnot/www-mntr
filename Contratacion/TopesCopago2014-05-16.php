	...
	while($row = ExFetchArray($res)){
		...
		if(ExNumRows($res2)){ $ban==1;?>
    	    ...
    	    <tr bgcolor="#e5e5e5" style="font-weight:bold" align="center">
        		<td>Tipo Asegurador</td><td>Tipo Usuario</td><td>Nivel</td><td>Clase</td><td>Tipo Copago</td><td>Valor</td><td>Tope Anual</td><td colspan="2">
	        </tr>        
<?			while($row2 = ExFetchArray($res2)){
				echo "<tr><td>$row2[3]</td><td>$row2[2]</td><td>$row2[4]</td><td>$row2[5]</td><td>$row2[8]</td><td align='right'>".number_format($row2[7],2)."</td><td align='right'>".number_format($row2[9],2)."</td>";?>
