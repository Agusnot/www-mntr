<?	if($DatNameSID){session_name("$DatNameSID");}
	...
	if($Guardar){
		...
		if(!$Edit)
		{
			...
			$fila3 = ExFetch($res3);			
			$AutoId = $fila3[0] +1;
			$cons="Insert into Salud.topescopago(compania,anio,tipousuario,tipoasegurador,nivelusu,clase,ambito,valor,tipocopago,topeanual,id,topeevento) values ('$Compania[0]','$Anio','$TipoUsuario','$TipoAsegurador','$Nivel','$Clase','$Ambito',$Valor,'$TipoCopago',$TopeAnual,$AutoId,$TopeEvento)";						
		}
		else
		{			
			$cons="Update Salud.topescopago set compania='$Compania[0]',anio='$Anio',tipousuario='$TipoUsuario',tipoasegurador='$TipoAsegurador',nivelusu='$Nivel',clase='$Clase',ambito='$Ambito',valor='$Valor',tipocopago='$TipoCopago',topeanual='$TopeAnual',topeevento='$TopeEvento' where Compania='$Compania[0]' and id='$Id'";			
		}
...
<tr>
	<td bgcolor="#e5e5e5" style="font-weight:bold">Ambito</td>
    <td>
    <select name="Ambito">
...
<tr>    
	...
	<td bgcolor="#e5e5e5" style="font-weight:bold">Tope x Evento</td>
	<td><input type="text" name="TopeEvento" value="<? echo $fila[11]?>" onKeyUp="xNumero(this)" onKeyDown="xNumero(this)"></td>
</tr>
<tr>
