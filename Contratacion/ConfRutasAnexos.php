		<?	
			...
			if($Guardar){		
				$cons="delete from salud.rutaimgsanexos where compania='$Compania[0]'";
				$res=ExQuery($cons);
				$Aux=str_replace('\\','/',$Ruta);
				$cons="insert into salud.rutaimgsanexos (compania,ruta) values ('$Compania[0]','$Aux')";
				$res=ExQuery($cons);
			}
		?>
				...
				<div <?php echo $alignDiv2Mentor; ?> class="div2">
					<form name="FORMA" method="post" enctype="multipart/form-data" onSubmit="return Validar()">
						<table class="tabla2"  <?php echo $borderTabla2Mentor; echo $bordercolorTabla2Mentor; echo $cellspacingTabla2Mentor; echo $cellpaddingTabla2Mentor; ?>> 
								<tr>
									<td class="encabezado2Horizontal">RUTA IMAGENES ANEXOS</td>
								</tr>
							<?
