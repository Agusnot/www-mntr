<?php	if($DatNameSID){session_name("$DatNameSID");}
                ...
                if($DiaIni == ""){
                    ...
                    if($AnioFin == ""){
                        ...
                        if($MesFin==""){
                            $MesFin = $Mes;
                            if($DiaFinal==""){
                                $numdiafin = cal_days_in_month(CAL_GREGORIAN, date("n", strtotime("$AnioFin-$MesFin-01 00:00:00")), date("Y", strtotime("$AnioFin-$MesFin-01 00:00:00")));
                                $DiaFinal = $numdiafin;
                            }
                        }
                    }
	...
	if($DiaIns!=''){
        ...
        // Marzo 25 de 2014
        // Replica los tiempos asignados de un dia para el resto de la semana
        if($RepDia!=""){
            $cons = "select * from salud.tempconsexterna where tmpcod='".$TMPCOD."' and dia='".$RepDia."'";
            $res = ExQuery($cons);
            
            //$diasrd = array("Domingo","Lunes","Martes","Miercoles","Jueves","Viernes","Sabado");
            
            //echo $cons."<br>";
            
            while($fila = ExFetchAssoc($res)){
                foreach($repdiaschk as $key => $value){
                    if($value!=$RepDia){
                        $consird="insert into salud.tempconsexterna (horaini,minsinicio,horasfin,minsfin,dia,idhora,compania,tmpcod) "
                            . "values (".$fila['horaini'].",".$fila['minsinicio'].",".$fila['horasfin'].",".$fila['minsfin'].",'".$key."',".$fila['idhora'].",'".$fila['compania']."','".$fila['tmpcod']."')";
                        $resird = ExQuery($consird);
                    }
                }
            }
        }
...
function repdias($Dia){
	document.FORMA.RepDia.value=$Dia;
	document.FORMA.NoSubmit.value=1;			
	document.FORMA.submit();
}
function salir(){
...
<table BORDER=1  style='font : normal normal small-caps 12px Tahoma;' border="1" bordercolor="#e5e5e5" cellpadding="8" align="center">
	...
	<tr>
        ...
        <select name="AnioIni" onChange="document.FORMA.NoSubmit.value=1;document.FORMA.submit()">
            <option></option>
                <?php		
	...
	<?php		}
        ...
        <td>Mes</td><td><?php $res=ExQuery("Select numero,mes from  central.meses");?>
	    <select name="MesIni" onChange="document.FORMA.NoSubmit.value=1;document.FORMA.submit()";><option></option><?php
		if($AnioIni!=''){			
			while($row = ExFetchArray($res))
			{
				if($MesIni==$row[0])
      ...
      <?php  if($MesIni!=''){
	  		for($i=1;$i<=$DiaFin;$i++){
				if($DiaIni==$i){
			?>	<option value="<? echo $i?>" selected><? echo $i?></option><?php
				}
				else{?>
				<option value="<? echo $i?>"><? echo $i?></option><?php
				}
			}
	  	}?>
     ...
     <?php if($DiaIni!=''){ 	 		 	
      ...
      <?php 				}
        ...
        <td>Mes</td><td>
        <?php $res=ExQuery("Select numero,mes from  central.meses");?>
...
<table>
<tr><td style="padding-right:20px; padding-bottom:20px;">
<table BORDER=1  style='font : normal normal small-caps 12px Tahoma;' border="1" bordercolor="#e5e5e5"  align="center">
    <tr  bgcolor="#e5e5e5" style="font-weight:bold" align="center">
        ...
        <!--<td>Seleccionar</td>-->
        <td><a href="#" onclick="repdias('Lunes')" ><img src="/Imgs/rightr.gif" alt="Copiar a dias seleccionados" title="Copiar a dias seleccionados" style=" border-width: 0px;"></a></td>
        <td><input type="checkbox" name="repdiaschk[<?php echo "Lunes"; ?>]" id="repdiaschk[<?php echo "Lunes"; ?>]"></td>
  	</tr>
    <tr>
		...
		{	if($fila[1]==0){$Cero2=0;}else{$Cero2='';}
			...
			if($n==1)
			{
				 $HorIL=$fila[0]; $MinIL=$fila[1]; $HorFL=$fila[2]; $MinFL=$fila[3];				 ?>
              	<tr align='center' <?php if($fila[5]){ echo "bgcolor='#FF6600' title='resitringidop al cup $fila[5] - ".$Cups[$fila[5]]."'";}?>>
			<?php	echo "<td colspan='2'>$fila[0]:$fila[1]$Cero2</td><td colspan='2'>$fila[2]:$fila[3]$Cero3</td><td>";?>				
         ...
         <?php }
			...
			{?>
				<tr align="center" <?php if($fila[5]){ echo "bgcolor='#FF6600' title='resitringidop al cup $fila[5] - ".$Cups[$fila[5]]."'";}?>>
			<?php	echo "<td colspan='2'>$fila[0]:$fila[1]$Cero2</td><td colspan='2'>$fila[2]:$fila[3]$Cero3</td></tr>";
			}
			$n--;
	...
	if($HorFL!=21)
	{
		...
		{ ?>
	        ...
	        <?php if($HoraIniL!=''){ 
	            ...
	            <td><?php if($MinsInicioL==50){$HoraIL=$HoraIniL+1;}else{$HoraIL=$HoraIniL;}?>           
...
<table BORDER=1  style='font : normal normal small-caps 12px Tahoma;' border="1" bordercolor="#e5e5e5"  align="center">
  <tr  bgcolor="#e5e5e5" style="font-weight:bold" align="center"> 
		<td colspan="2" align="center">Martes</td>
                <td><a href="#" onclick="repdias('Martes')" ><img src="/Imgs/rightr.gif" alt="Copiar a dias seleccionados" title="Copiar a dias seleccionados" style=" border-width: 0px;"></a></td>
                <td><input type="checkbox" name="repdiaschk[<?php echo "Martes"; ?>]" id="repdiaschk[<?php echo "Martes"; ?>]"></td>
  </tr>
    <tr>
    	<td bgcolor="#e5e5e5" style="font-weight:bold" align="center" colspan="2">Hora inicio</td><td bgcolor="#e5e5e5" style="font-weight:bold" align="center" colspan="2">Hora Fin</td>
    </tr>
...
<table BORDER=1  style='font : normal normal small-caps 12px Tahoma;' border="1" bordercolor="#e5e5e5"  align="center"> 
  <tr  bgcolor="#e5e5e5" style="font-weight:bold" align="center">            
	  <td colspan="2" >Miercoles</td> 
          <td><a href="#" onclick="repdias('Miercoles')" ><img src="/Imgs/rightr.gif" alt="Copiar a dias seleccionados" title="Copiar a dias seleccionados" style=" border-width: 0px;"></a></td>
          <td><input type="checkbox" name="repdiaschk[<?php echo "Miercoles"; ?>]" id="repdiaschk[<?php echo "Miercoles"; ?>]"></td>
  </tr>    	
    <tr>
    	<td bgcolor="#e5e5e5" style="font-weight:bold" align="center" colspan="2">Hora inicio</td><td bgcolor="#e5e5e5" style="font-weight:bold" align="center" colspan="2">Hora Fin</td>
    </tr>
...
<table BORDER=1  style='font : normal normal small-caps 12px Tahoma;' border="1" bordercolor="#e5e5e5"  align="center"> 
  <tr  bgcolor="#e5e5e5" style="font-weight:bold" align="center">            
		<td colspan="2" >Jueves</td> 
                <td><a href="#" onclick="repdias('Jueves')" ><img src="/Imgs/rightr.gif" alt="Copiar a dias seleccionados" title="Copiar a dias seleccionados" style=" border-width: 0px;"></a></td>
                <td><input type="checkbox" name="repdiaschk[<?php echo "Jueves"; ?>]" id="repdiaschk[<?php echo "Jueves"; ?>]"></td>
  </tr>    	
    <tr>
    	<td bgcolor="#e5e5e5" style="font-weight:bold" align="center" colspan="2">Hora inicio</td><td bgcolor="#e5e5e5" style="font-weight:bold" align="center" colspan="2">Hora Fin</td>
    </tr>
...
<table BORDER=1  style='font : normal normal small-caps 12px Tahoma;' border="1" bordercolor="#e5e5e5"  align="center"> 
  <tr  bgcolor="#e5e5e5" style="font-weight:bold" align="center">            
		<td colspan="2" >Viernes</td>  
                <td><a href="#" onclick="repdias('Viernes')" ><img src="/Imgs/rightr.gif" alt="Copiar a dias seleccionados" title="Copiar a dias seleccionados" style=" border-width: 0px;"></a></td>
                <td><input type="checkbox" name="repdiaschk[<?php echo "Viernes"; ?>]" id="repdiaschk[<?php echo "Viernes"; ?>]"></td>
  </tr>    	
    <tr>
    	<td bgcolor="#e5e5e5" style="font-weight:bold" align="center" colspan="2">Hora inicio</td><td bgcolor="#e5e5e5" style="font-weight:bold" align="center" colspan="2">Hora Fin</td>
    </tr>
...
<td colspan="2" align="center"  style="padding-right:20px; padding-bottom:20px;">
<table BORDER=1  style='font : normal normal small-caps 12px Tahoma;' border="1" bordercolor="#e5e5e5"  align="center"> 
  <tr  bgcolor="#e5e5e5" style="font-weight:bold" align="center">            
		 <td colspan="2" >Sabado</td>  
                 <td><a href="#" onclick="repdias('Sabado')" ><img src="/Imgs/rightr.gif" alt="Copiar a dias seleccionados" title="Copiar a dias seleccionados" style=" border-width: 0px;"></a></td>
                <td><input type="checkbox" name="repdiaschk[<?php echo "Sabado"; ?>]" id="repdiaschk[<?php echo "Sabado"; ?>]"></td>
  </tr>    	
    <tr>
    	<td bgcolor="#e5e5e5" style="font-weight:bold" align="center" colspan="2">Hora inicio</td><td bgcolor="#e5e5e5" style="font-weight:bold" align="center" colspan="2">Hora Fin</td>
    </tr>
...
<tr>
<td colspan="4" align="center" style="padding-right:20px; padding-bottom:20px;">
<table BORDER=1  style='font : normal normal small-caps 12px Tahoma;' border="1" bordercolor="#e5e5e5"  align="center"> 
  <tr  bgcolor="#e5e5e5" style="font-weight:bold" align="center">            
		 <td colspan="2" >Domingo</td>  
                 <td><a href="#" onclick="repdias('Domingo')" ><img src="/Imgs/rightr.gif" alt="Copiar a dias seleccionados" title="Copiar a dias seleccionados" style=" border-width: 0px;"></a></td>
                <td><input type="checkbox" name="repdiaschk[<?php echo "Domingo"; ?>]" id="repdiaschk[<?php echo "Domingo"; ?>]"></td>
  </tr>    	
    <tr>
    	<td bgcolor="#e5e5e5" style="font-weight:bold" align="center" colspan="2">Hora inicio</td><td bgcolor="#e5e5e5" style="font-weight:bold" align="center" colspan="2">Hora Fin</td>
    </tr>
...
<input type="hidden" name="RepDia" value="">
