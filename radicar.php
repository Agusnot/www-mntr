...
<?	if($FechaIni&&$FechaFin){
		...
		//echo $usuario[1];
		$cons="select nofactura,subtotal,copago,descuento,total,fechaglosa,entidad,estado,individual,usucrea,fechacrea,fecharadic,nocompcontable from facturacion.facturascredito 
