                ...
                if(($Mostrar || $pos !== false)&&($pos === false || $fecha !== false))
                {
                    ...
                    <tr>
                        ...
                        <td align="center">
                            ...
                            value="<? echo $Meds[8]?>" maxlength="7" onKeyUp="xNumero(this)" onKeyDown="xNumero(this)"
                            onBlur="campoNumero(this);
                            ValidarCantidad('<? echo $Meds[0]?>','<? echo $Meds[3]?>','<? echo $Meds[8]?>','<? echo $Meds[20]?>','<?echo $Y?>');"
                            ...
                            <input type="hidden" name="Despacho[<?echo $Y?>][4]" value="<? echo ($VrCosto * $Meds[8])?>"
                            ...
                            <input type="hidden" name="Despacho[<?echo $Y?>][6]" value="<? echo ($Tarifa[$Meds[19]][$Meds[3]] * $Meds[8])?>"
