	...
	<?php
		...
		function contarRegistrosMySQLCodMed2010() {
			$cnx = conectar_mysql("Contabilidad");
			$cons = "SELECT COUNT(*) AS conteoMySQL FROM Salud.Codmedicamentos2010";
		...
		function  funcion0005CodMed2010($cadenaBusqueda,$cadenaReemplazo)  {
		...
		function  funcion0006CodMed2010($cadenaBusqueda,$cadenaReemplazo)  {
		// Busca y reemplaza ocurrencias en una tabla
			$cnx= conectar_postgres();
		...
		function  funcion0007CodMed2010($cadenaBusqueda,$cadenaReemplazo)  {
		// Busca y reemplaza ocurrencias en una tabla
			$cnx= conectar_postgres();
		...
		function  funcion0008CodMed2010($cadenaBusqueda,$cadenaReemplazo)  {
		// Busca y reemplaza ocurrencias en una tabla
			$cnx= conectar_postgres();
		...
		function funcion0010CodMed2010() {
			// Selecciona los registros MySQL (Origen)
			global $res;
			$cnx = conectar_mysql("Salud");
			$cons = "SELECT *  FROM Salud.codmedicamentos2010";
			$res =  mysql_query($cons);
			return $res; 
		...
		function  funcion0012CodMed2010(){
		// Llena una matriz con el resultado de la consulta MySQL
			
			unset($matriz); 
			global  $matriz;	
			$res = funcion0010CodMed2010();
			$posicion=0;
			...
			function funcion0013CodMed2010()  {
		...
		function migrarCodMed2010() {
			
			
			
			// Tabla Consumo.almacenesppales
			funcion0006CodMed2010(utf8_encode("Á"),'&Aacute;');			
			funcion0006CodMed2010(utf8_encode("É"),'&Eacute;');
			funcion0006CodMed2010(utf8_encode("Í"),'&Iacute;');
			funcion0006CodMed2010(utf8_encode("Ó"),'&Oacute;');
			funcion0006CodMed2010(utf8_encode("Ú"),'&Uacute;');
			funcion0006CodMed2010(utf8_encode("Ñ"),'&Ntilde;');
			
			
			// Tabla Consumo.bodegas
			funcion0007CodMed2010(utf8_encode("Á"),'&Aacute;');			
			funcion0007CodMed2010(utf8_encode("É"),'&Eacute;');
			funcion0007CodMed2010(utf8_encode("Í"),'&Iacute;');
			funcion0007CodMed2010(utf8_encode("Ó"),'&Oacute;');
			funcion0007CodMed2010(utf8_encode("Ú"),'&Uacute;');
			funcion0007CodMed2010(utf8_encode("Ñ"),'&Ntilde;');
			
			// Tabla Consumo.TiposProducto
			funcion0008CodMed2010(utf8_encode("Á"),'&Aacute;');			
			funcion0008CodMed2010(utf8_encode("É"),'&Eacute;');
			funcion0008CodMed2010(utf8_encode("Í"),'&Iacute;');
			funcion0008CodMed2010(utf8_encode("Ó"),'&Oacute;');
			funcion0008CodMed2010(utf8_encode("Ú"),'&Uacute;');
			funcion0008CodMed2010(utf8_encode("Ñ"),'&Ntilde;');
			
			
			
			
			
			funcion0010CodMed2010();
			funcion0012CodMed2010();
			funcion0013CodMed2010();
			...
			// Tabla Consumo.almacenesppales
			funcion0006CodMed2010('&Aacute;', utf8_encode("Á"));			
			funcion0006CodMed2010('&Eacute;', utf8_encode("É"));
			funcion0006CodMed2010('&Iacute;', utf8_encode("Í"));
			funcion0006CodMed2010('&Oacute;', utf8_encode("Ó"));
			funcion0006CodMed2010('&Uacute;',utf8_encode("Ú"));
			funcion0006CodMed2010('&Ntilde;',utf8_encode("Ñ"));
			
			// Tabla Consumo.bodegas
			funcion0007CodMed2010('&Aacute;', utf8_encode("Á"));			
			funcion0007CodMed2010('&Eacute;', utf8_encode("É"));
			funcion0007CodMed2010('&Iacute;', utf8_encode("Í"));
			funcion0007CodMed2010('&Oacute;', utf8_encode("Ó"));
			funcion0007CodMed2010('&Uacute;',utf8_encode("Ú"));
			funcion0007CodMed2010('&Ntilde;',utf8_encode("Ñ"));
			
			// Tabla Consumo.tiposproducto
			funcion0008CodMed2010('&Aacute;', utf8_encode("Á"));			
			funcion0008CodMed2010('&Eacute;', utf8_encode("É"));
			funcion0008CodMed2010('&Iacute;', utf8_encode("Í"));
			funcion0008CodMed2010('&Oacute;', utf8_encode("Ó"));
			funcion0008CodMed2010('&Uacute;',utf8_encode("Ú"));
			funcion0008CodMed2010('&Ntilde;',utf8_encode("Ñ"));
			
			
			
		    // Tabla Consumo.codproductos
			funcion0005CodMed2010('&Aacute;', utf8_encode("Á"));			
			funcion0005CodMed2010('&Eacute;', utf8_encode("É"));
			funcion0005CodMed2010('&Iacute;', utf8_encode("Í"));
			funcion0005CodMed2010('&Oacute;', utf8_encode("Ó"));
			funcion0005CodMed2010('&Uacute;',utf8_encode("Ú"));
			funcion0005CodMed2010('&Ntilde;',utf8_encode("Ñ"));
