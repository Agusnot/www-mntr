	...
	<html>	
		<head>
			<title> Migracion Formato Referencia</title>
	...
	<?php
		...
		function contarRegistrosMySQL() {
			...
			$cons = "SELECT COUNT(*)  AS conteomysql FROM Salud.Referencia";
		...
		function insertarFormatos() {
				...
				$cons= "COPY HistoriaClinica.Formatos FROM '$ruta/Migraciones/HistoriaClinicaFrms/HistoriaClinica/Referencia/Formatos.csv' WITH DELIMITER ';' CSV HEADER;";
				$res =  @pg_query($cons);
					if (!$res) {
			...
			function insertarItemsxFormatos() {
				...
				$cnx = conectar_postgres();
				$ruta = $_SERVER['DOCUMENT_ROOT'];
				$cons= "COPY HistoriaClinica.ItemsxFormatos FROM '$ruta/Migraciones/HistoriaClinicaFrms/HistoriaClinica/Referencia/ItemsxFormatos.csv' WITH DELIMITER ';' CSV HEADER;";
				$res =  @pg_query($cons);
					if (!$res) {
						echo "<p class='error1'> Error de ejecucion </p>".pg_last_error()."<br>";
						echo "<p class= 'subtitulo1'>Comando SQL </p> <br>".$cons."<br/>";
			...
			function insertarPermisosxFormato() {
				...
				$cnx = conectar_postgres();
				$ruta = $_SERVER['DOCUMENT_ROOT'];
				$cons= "COPY HistoriaClinica.PermisosxFormato FROM '$ruta/Migraciones/HistoriaClinicaFrms/HistoriaClinica/Referencia/PermisosxFormato.csv' WITH DELIMITER ';' CSV HEADER;";
				$res =  @pg_query($cons);
					if (!$res) {
						echo "<p class='error1'> Error de ejecucion </p>".pg_last_error()."<br>";
						echo "<p class= 'subtitulo1'>Comando SQL </p> <br>".$cons."<br/>";
			...
			function insertarAmbitosxFormato() {
				...
				$cnx = conectar_postgres();
				$ruta = $_SERVER['DOCUMENT_ROOT'];
				$cons= "COPY HistoriaClinica.AmbitosxFormato FROM '$ruta/Migraciones/HistoriaClinicaFrms/HistoriaClinica/Referencia/AmbitosxFormato.csv' WITH DELIMITER ';' CSV HEADER;";
				$res =  @pg_query($cons);
					if (!$res) {
						echo "<p class='error1'> Error de ejecucion </p>".pg_last_error()."<br>";
						echo "<p class= 'subtitulo1'>Comando SQL </p> <br>".$cons."<br/>";
			...
			function insertarDxFormatos() {
				...
				$cnx = conectar_postgres();
				$ruta = $_SERVER['DOCUMENT_ROOT'];
				$cons= "COPY HistoriaClinica.DxFormatos FROM '$ruta/Migraciones/HistoriaClinicaFrms/HistoriaClinica/Referencia/DxFormatos.csv' WITH DELIMITER ';' CSV HEADER;";
				$res =  @pg_query($cons);
					if (!$res) {
						echo "<p class='error1'> Error de ejecucion </p>".pg_last_error()."<br>";
						echo "<p class= 'subtitulo1'>Comando SQL </p> <br>".$cons."<br/>";
			...
			function insertarCupsxFormatos() {
				...
				$cnx = conectar_postgres();
				$ruta = $_SERVER['DOCUMENT_ROOT'];
				$cons= "COPY HistoriaClinica.CupsxFormatos FROM '$ruta/Migraciones/HistoriaClinicaFrms/HistoriaClinica/Referencia/CupsxFormatos.csv' WITH DELIMITER ';' CSV HEADER;";
				$res =  @pg_query($cons);
					if (!$res) {
						echo "<p class='error1'> Error de ejecucion </p>".pg_last_error()."<br>";
						echo "<p class= 'subtitulo1'>Comando SQL </p> <br>".$cons."<br/>";
			...
			function insertarVoBoxFormatos() {
				...
				$cnx = conectar_postgres();
				$ruta = $_SERVER['DOCUMENT_ROOT'];
				$cons= "COPY HistoriaClinica.VoBoxFormatos FROM '$ruta/Migraciones/HistoriaClinicaFrms/HistoriaClinica/Referencia/VoBoxFormatos.csv' WITH DELIMITER ';' CSV HEADER;";
				$res =  @pg_query($cons);
					if (!$res) {
						echo "<p class='error1'> Error de ejecucion </p>".pg_last_error()."<br>";
						echo "<p class= 'subtitulo1'>Comando SQL </p> <br>".$cons."<br/>";
			...
			function insertarAjustePermanente() {
				...
				$cnx = conectar_postgres();
				$ruta = $_SERVER['DOCUMENT_ROOT'];
				$cons= "COPY HistoriaClinica.AjustePermanente FROM '$ruta/Migraciones/HistoriaClinicaFrms/HistoriaClinica/Referencia/AjustePermanente.csv' WITH DELIMITER ';' CSV HEADER;";
				$res =  @pg_query($cons);
					if (!$res) {
						echo "<p class='error1'> Error de ejecucion </p>".pg_last_error()."<br>";
						echo "<p class= 'subtitulo1'>Comando SQL </p> <br>".$cons."<br/>";
		...
		// Crea un archivo HTML donde se documentaran los registros que no se insertaron en la tabla de migraciones
			...
			global $res;
			$cnx = conectar_mysql("Salud");
			$cons = "SELECT Referencia.*, TIME(Fecha) AS hora  FROM Salud.Referencia  ORDER BY Fecha ASC ";
			$res =  @mysql_query($cons);
			if (!$res)  {
		...
		function crearTablaFormato($tabla){
				$cnx = conectar_postgres();				
				$cons= "CREATE TABLE histoclinicafrms.$tabla(  formato character varying(150) NOT NULL,  tipoformato character varying(150) NOT NULL,  id_historia integer NOT NULL DEFAULT 0,  usuario character varying(150) NOT NULL,  cargo character varying(80) NOT NULL,  fecha date,  hora time without time zone,  cedula character varying(15) NOT NULL,  ambito character varying(150),  unidadhosp character varying(150),  numservicio integer,  compania character varying(60) NOT NULL,  cerrado integer,  noliquidacion integer DEFAULT 0,  finalidadconsult character varying(5),  causaexterna character varying(5),  dx1 character varying(6),  dx2 character varying(6),  dx3 character varying(6),  dx4 character varying(6),  dx5 character varying(6),  tipodx character varying(1),  numproced integer,  usuarioajuste character varying(30),  fechaajuste date,  padretipoformato character varying(150),  padreformato character varying(150),  id_historia_origen integer,  cmp00004 text,  cmp00006 text,  cmp00008 text,  cmp00010 character varying(255),  cmp00013 text,  cmp00015 text,  cmp00017 text,  cmp00019 text,  CONSTRAINT pkhctbl$tabla PRIMARY KEY (formato , tipoformato , id_historia , cedula , compania ),  CONSTRAINT fkambtbl$tabla FOREIGN KEY (ambito, compania)      REFERENCES salud.ambitos (ambito, compania) MATCH SIMPLE      ON UPDATE CASCADE ON DELETE RESTRICT,  CONSTRAINT fkitemsxtbl$tabla FOREIGN KEY (formato, tipoformato, compania)      REFERENCES historiaclinica.formatos (formato, tipoformato, compania) MATCH SIMPLE      ON UPDATE CASCADE ON DELETE RESTRICT,  CONSTRAINT fkpabxtbl$tabla FOREIGN KEY (unidadhosp, compania, ambito)      REFERENCES salud.pabellones (pabellon, compania, ambito) MATCH SIMPLE      ON UPDATE CASCADE ON DELETE RESTRICT)WITH (  OIDS=FALSE)";		  		
				$res = @pg_query($cnx,$cons);						
				if (!$res) {							
				echo "<p class='error1'> Error de ejecucion </p>".pg_last_error()."<br>";
				echo "<p class= 'subtitulo1'>Comando SQL </p> <br>".$cons."<br/>";
		...
		function insertarRegistroMigracion($formato,$tipoformato,$id_historia,$usuario_rm ,$cargo,$fecha,$hora,$cedula,$ambito,$unidadhosp,$numservicio,$compania,$cerrado , $noliquidacion,$finalidadconsult,$causaexterna,$dx1,$dx2,$dx3,$dx4,$dx5,$cmp00004,$cmp00006,$cmp00008,$cmp00010,$cmp00013, $cmp00015, $cmp00017, $cmp00019, $error) {
		//Realiza la insercion en Postgresql con base en los parametros
			global  $tablafrm;
			$tablaMig = $tablafrm."Migracion";
			$cnx = 	conectar_postgres();
			$cons = "INSERT INTO HistoClinicaFrms.$tablaMig (formato,tipoformato,id_historia,usuario,cargo,fecha,hora,cedula,ambito,unidadhosp,numservicio,compania,cerrado , noliquidacion,finalidadconsult,causaexterna,dx1,dx2,dx3,dx4,dx5,cmp00004,cmp00006,cmp00008,cmp00010,cmp00013, cmp00015, cmp00017, cmp00019, error) VALUES ('$formato','$tipoformato','$id_historia','$usuario_rm','$cargo','$fecha','$hora','$cedula','$ambito','$unidadhosp','$numservicio','$compania','$cerrado', '$noliquidacion','$finalidadconsult','$causaexterna','$dx1','$dx2','$dx3','$dx4','$dx5','$cmp00004','$cmp00006','$cmp00008','$cmp00010','$cmp00013', '$cmp00015', '$cmp00017', '$cmp00019', '$error')"	;
		...
		function insertarRegistroPostgresql($formato,$tipoformato,$id_historia,$usuario_rm ,$cargo,$fecha,$hora,$cedula,$ambito,$unidadhosp,$numservicio,$compania,$cerrado , $noliquidacion,$finalidadconsult,$causaexterna,$dx1,$dx2,$dx3,$dx4,$dx5,$cmp00004,$cmp00006,$cmp00008,$cmp00010,$cmp00013, $cmp00015, $cmp00017, $cmp00019) {
		//Realiza la insercion en Postgresql con base en los parametros
			global  $tablafrm;
			$cnx = 	conectar_postgres();
			$cons = "INSERT INTO HistoClinicaFrms.$tablafrm (formato,tipoformato,id_historia,usuario,cargo,fecha,hora,cedula,ambito,unidadhosp,numservicio,compania,cerrado , noliquidacion,finalidadconsult,causaexterna,dx1,dx2,dx3,dx4,dx5,cmp00004,cmp00006,cmp00008,cmp00010,cmp00013, cmp00015, cmp00017, cmp00019) VALUES ('$formato','$tipoformato','$id_historia','$usuario_rm','$cargo','$fecha','$hora','$cedula','$ambito','$unidadhosp','$numservicio','$compania','$cerrado', '$noliquidacion','$finalidadconsult','$causaexterna','$dx1','$dx2','$dx3','$dx4','$dx5','$cmp00004','$cmp00006','$cmp00008','$cmp00010','$cmp00013', '$cmp00015', '$cmp00017', '$cmp00019')"	;
			$cons = str_replace( "'NULL'","NULL",$cons  );	
			$res = @pg_query($cnx, $cons);
				if (!$res) {
					$consUTF8 = utf8_encode($cons);
					$resUTF8 = @pg_query($cnx, $consUTF8);					
						if (!$resUTF8) {
							...
							insertarRegistroMigracion($formato,$tipoformato,$id_historia,$usuario_rm ,$cargo,$fecha,$hora,$cedula,$ambito,$unidadhosp,$numservicio,$compania,$cerrado , $noliquidacion,$finalidadconsult,$causaexterna,$dx1,$dx2,$dx3,$dx4,$dx5,$cmp00004,$cmp00006,$cmp00008,$cmp00010,$cmp00013, $cmp00015, $cmp00017, $cmp00019, $error);					
		...
		// Llena una matriz con el resultado de la consulta MySQL
			...
			$posicion=0;
				...
				{	
					...
					$matriz["dxingreso"][$posicion] = $fila["DxIngreso"];
					$matriz["fingreso"][$posicion] = $fila["FIngreso"];
					$matriz["horaing"][$posicion] = $fila["HoraIng"];
					
					
					$matriz["destino"][$posicion] = $fila["Destino"];
					$matriz["institucion"][$posicion] = $fila["Institucion"];
					$matriz["especialidad"][$posicion] = $fila["Especialidad"];
					$matriz["tiporeferencia"][$posicion] = $fila["TipoReferencia"];
					$matriz["resumen"][$posicion] = $fila["Resumen"];
					$matriz["ttofarma"][$posicion] = $fila["TtoFarma"];
					$matriz["ttonofarma"][$posicion] = $fila["TtoNoFarma"];
					$matriz["laboratorios"][$posicion] = $fila["Laboratorios"];
					$matriz["justificacion"][$posicion] = $fila["Justificacion"];
					$matriz["exfisico"][$posicion] = $fila["ExFisico"];
			...
			// Recorre la matriz con los valores MySQL  inserta los valores en Postgresql
				...
				global $res,$matriz, $tablafrm;
					...
					$destino=$matriz["destino"][$pos];				
					$destino = eliminarCaracteresEspFormatos($destino);
					
					$institucion=$matriz["institucion"][$pos];
					$institucion = eliminarCaracteresEspFormatos($institucion);
					
					$especialidad=$matriz["especialidad"][$pos];
					$especialidad = eliminarCaracteresEspFormatos($especialidad);
					
					
					$tiporeferencia=$matriz["tiporeferencia"][$pos];
					$tiporeferencia = eliminarCaracteresEspFormatos($tiporeferencia);
					
					$resumen=$matriz["resumen"][$pos];
					$resumen = eliminarCaracteresEspFormatos($resumen);
					
					$ttofarma=$matriz["ttofarma"][$pos];
					$ttofarma = eliminarCaracteresEspFormatos($ttofarma);
					
					$ttonofarma=$matriz["ttonofarma"][$pos];
					$ttonofarma = eliminarCaracteresEspFormatos($ttonofarma);
					
					$laboratorios=$matriz["laboratorios"][$pos];
					$laboratorios = eliminarCaracteresEspFormatos($laboratorios);
					
					$justificacion=$matriz["justificacion"][$pos];
					$justificacion = eliminarCaracteresEspFormatos($justificacion);
					
					
					$exfisico=$matriz["exfisico"][$pos];
					$exfisico = eliminarCaracteresEspFormatos($exfisico);
					
					
					$cmp00004 = $destino;
					
					$cmp00006 = $institucion;
					
					$cmp00008 = $especialidad;
					
					$cmp00010 = $tiporeferencia;
					
					$dxingreso = $matriz["dxingreso"][$pos];
					$dxingreso = eliminarCaracteresEspFormatos($dxingreso);
					
					$fechaingreso = $matriz["fingreso"][$pos];
					$horaingreso = $matriz["horaing"][$pos];
					
					$cmp00013_1 = "<b>Datos Ingreso </b><br>Diagnostico Ingreso: ".$dxingreso."<br>Fecha de ingreso: ".$fechaingreso."<br>Hora Ingreso: ".$horaingreso."<br><br>";
					$cmp00013_2 ="<b> Resumen de Historia Clinica: </b><br>".$resumen."<br><br>";
					$cmp00013_3 = "<b> Tratamiento Farmacologico : </b> <br>".$ttofarma."<br><br>";
					$cmp00013_4 = "<b> Tratamiento No Farmacologico : </b> <br>".$ttonofarma."<br><br>";
					$cmp00013_5 = "<b> Justificacion : </b> <br>".$justificacion."<br><br>";
					
					
					$cmp00013 = $cmp00013_1.$cmp00013_2.$cmp00013_3.$cmp00013_4.$cmp00013_5;
					
					$cmp00015 = $exfisico;
					
					$cmp00017 = 'NULL';
					
					$cmp00019 = $laboratorios;
					...
					insertarRegistroPostgresql($formato,$tipoformato,$id_historia,$usuario_rm ,$cargo,$fecha,$hora,$cedula,$ambito,$unidadhosp,$numservicio,$compania,$cerrado , $noliquidacion,$finalidadconsult,$causaexterna,$dx1,$dx2,$dx3,$dx4,$dx5,$cmp00004,$cmp00006,$cmp00008,$cmp00010,$cmp00013, $cmp00015, $cmp00017, $cmp00019);
		...
		global $tablafrm, $tipoformato , $formato ;			
			...
			*/
			...
			echo "<div align='center'> <p class='mensajeFinalizacion'>Ha terminado la migracion del Formato 'Referencia'</p> </div>";
		...
		if($_GET['formato']="Referencia") {
		
				echo "<fieldset>";			
				echo "<legend> Migracion tabla MySQL </legend>";
				echo "<br>";
				echo "<span align='left'> <a href='../../index.php?migracion=MIG024' class = 'link1'> Panel de Administracion </a> </span>";
				echo "<br>";
