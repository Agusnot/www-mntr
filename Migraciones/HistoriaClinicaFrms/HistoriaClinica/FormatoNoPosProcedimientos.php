	...
	<html>	
		<head>
			<title> Migracion Formato FormatoNoPOSProcedimientos</title>
	...
	<?php
		...
		function insertarFormatos() {
				...
				$cons= "COPY HistoriaClinica.Formatos FROM '$ruta/Migraciones/HistoriaClinicaFrms/HistoriaClinica/FormatoNoPOSProcedimientos/Formatos.csv' WITH DELIMITER ';' CSV HEADER;";
				$res =  @pg_query($cons);
					if (!$res) {
			...
			function insertarItemsxFormatos() {
				...
				$cnx = conectar_postgres();
				$ruta = $_SERVER['DOCUMENT_ROOT'];
				$cons= "COPY HistoriaClinica.ItemsxFormatos FROM '$ruta/Migraciones/HistoriaClinicaFrms/HistoriaClinica/FormatoNoPOSProcedimientos/ItemsxFormatos.csv' WITH DELIMITER ';' CSV HEADER;";
				$res =  @pg_query($cons);
					if (!$res) {
						echo "<p class='error1'> Error de ejecucion </p>".pg_last_error()."<br>";
						echo "<p class= 'subtitulo1'>Comando SQL </p> <br>".$cons."<br/>";
			...
			function insertarPermisosxFormato() {
				...
				$cnx = conectar_postgres();
				$ruta = $_SERVER['DOCUMENT_ROOT'];
				$cons= "COPY HistoriaClinica.PermisosxFormato FROM '$ruta/Migraciones/HistoriaClinicaFrms/HistoriaClinica/FormatoNoPOSProcedimientos/PermisosxFormato.csv' WITH DELIMITER ';' CSV HEADER;";
				$res =  @pg_query($cons);
					if (!$res) {
						echo "<p class='error1'> Error de ejecucion </p>".pg_last_error()."<br>";
						echo "<p class= 'subtitulo1'>Comando SQL </p> <br>".$cons."<br/>";
			...
			function insertarAmbitosxFormato() {
				...
				$cnx = conectar_postgres();
				$ruta = $_SERVER['DOCUMENT_ROOT'];
				$cons= "COPY HistoriaClinica.AmbitosxFormato FROM '$ruta/Migraciones/HistoriaClinicaFrms/HistoriaClinica/FormatoNoPOSProcedimientos/AmbitosxFormato.csv' WITH DELIMITER ';' CSV HEADER;";
				$res =  @pg_query($cons);
					if (!$res) {
						echo "<p class='error1'> Error de ejecucion </p>".pg_last_error()."<br>";
						echo "<p class= 'subtitulo1'>Comando SQL </p> <br>".$cons."<br/>";
			...
			function insertarDxFormatos() {
				...
				$cnx = conectar_postgres();
				$ruta = $_SERVER['DOCUMENT_ROOT'];
				$cons= "COPY HistoriaClinica.DxFormatos FROM '$ruta/Migraciones/HistoriaClinicaFrms/HistoriaClinica/FormatoNoPOSProcedimientos/DxFormatos.csv' WITH DELIMITER ';' CSV HEADER;";
				$res =  @pg_query($cons);
					if (!$res) {
						echo "<p class='error1'> Error de ejecucion </p>".pg_last_error()."<br>";
						echo "<p class= 'subtitulo1'>Comando SQL </p> <br>".$cons."<br/>";
			...
			function insertarCupsxFormatos() {
				...
				$cnx = conectar_postgres();
				$ruta = $_SERVER['DOCUMENT_ROOT'];
				$cons= "COPY HistoriaClinica.CupsxFormatos FROM '$ruta/Migraciones/HistoriaClinicaFrms/HistoriaClinica/FormatoNoPOSProcedimientos/CupsxFormatos.csv' WITH DELIMITER ';' CSV HEADER;";
				$res =  @pg_query($cons);
					if (!$res) {
						echo "<p class='error1'> Error de ejecucion </p>".pg_last_error()."<br>";
						echo "<p class= 'subtitulo1'>Comando SQL </p> <br>".$cons."<br/>";
			...
			function insertarVoBoxFormatos() {
				...
				$cnx = conectar_postgres();
				$ruta = $_SERVER['DOCUMENT_ROOT'];
				$cons= "COPY HistoriaClinica.VoBoxFormatos FROM '$ruta/Migraciones/HistoriaClinicaFrms/HistoriaClinica/FormatoNoPOSProcedimientos/VoBoxFormatos.csv' WITH DELIMITER ';' CSV HEADER;";
				$res =  @pg_query($cons);
					if (!$res) {
						echo "<p class='error1'> Error de ejecucion </p>".pg_last_error()."<br>";
						echo "<p class= 'subtitulo1'>Comando SQL </p> <br>".$cons."<br/>";
			...
			function insertarAjustePermanente() {
				...
				$cnx = conectar_postgres();
				$ruta = $_SERVER['DOCUMENT_ROOT'];
				$cons= "COPY HistoriaClinica.AjustePermanente FROM '$ruta/Migraciones/HistoriaClinicaFrms/HistoriaClinica/FormatoNoPOSProcedimientos/AjustePermanente.csv' WITH DELIMITER ';' CSV HEADER;";
				$res =  @pg_query($cons);
					if (!$res) {
						echo "<p class='error1'> Error de ejecucion </p>".pg_last_error()."<br>";
						echo "<p class= 'subtitulo1'>Comando SQL </p> <br>".$cons."<br/>";
		...
		function crearTablaFormato($tabla){
				$cnx = conectar_postgres();				
				$cons= "CREATE TABLE histoclinicafrms.$tabla(  formato character varying(150) NOT NULL,  tipoformato character varying(150) NOT NULL,  id_historia integer NOT NULL DEFAULT 0,  usuario character varying(150) NOT NULL,  cargo character varying(80) NOT NULL,  fecha date,  hora time without time zone,  cedula character varying(15) NOT NULL,  ambito character varying(150),  unidadhosp character varying(150),  numservicio integer,  compania character varying(60) NOT NULL,  cerrado integer,  noliquidacion integer DEFAULT 0,  finalidadconsult character varying(5),  causaexterna character varying(5),  dx1 text,  dx2 text,  dx3 text,  dx4 text,  dx5 character varying(6),  tipodx character varying(1),  numproced integer,  usuarioajuste character varying(30),  fechaajuste date,  padretipoformato character varying(150),  padreformato character varying(150),  id_historia_origen integer,  cmp00003 character varying(10000),  idsvital numeric,  cmp00005 text,cmp00007 text,  cmp00009 text, cmp00011 text,  cmp00013 text,  cmp00015 text,  cmp00017 text,  cmp00019 character varying(255),  cmp00020 character varying(255),  cmp00021 character varying(255),  CONSTRAINT pkhctbl$tabla PRIMARY KEY (formato , tipoformato , id_historia , cedula , compania ),  CONSTRAINT fkambtbl$tabla FOREIGN KEY (ambito, compania)      REFERENCES salud.ambitos (ambito, compania) MATCH SIMPLE      ON UPDATE CASCADE ON DELETE RESTRICT,  CONSTRAINT fkitemsxtbl$tabla FOREIGN KEY (formato, tipoformato, compania)      REFERENCES historiaclinica.formatos (formato, tipoformato, compania) MATCH SIMPLE      ON UPDATE CASCADE ON DELETE RESTRICT,  CONSTRAINT fkpabxtbl$tabla FOREIGN KEY (unidadhosp, compania, ambito)      REFERENCES salud.pabellones (pabellon, compania, ambito) MATCH SIMPLE      ON UPDATE CASCADE ON DELETE RESTRICT)WITH (  OIDS=FALSE)";	
	  			$res = @pg_query($cnx,$cons);		
				if (!$res) {							
				echo "<p class='error1'> Error de ejecucion </p>".pg_last_error()."<br>";
				echo "<p class= 'subtitulo1'>Comando SQL </p> <br>".$cons."<br/>";
		...
		function insertarRegistroMigracion($formato,$tipoformato,$id_historia,$usuario_rm,$cargo,$fecha,$hora,$cedula,$ambito,$unidadhosp,$numservicio,$compania,$cerrado , $noliquidacion,$finalidadconsult,$causaexterna,$dx1,$dx2,$dx3,$dx4,$dx5,$cmp00003,$cmp00005,$cmp00007,$cmp00009,$cmp00011,$cmp00013, $cmp00015, $cmp00017, $cmp00019, $cmp00020, $cmp00021, $error) {
		//Realiza la insercion en Postgresql con base en los parametros
			global  $tablafrm;
			$tablaMig = $tablafrm."Migracion";
			$cnx = 	conectar_postgres();
			$cons = "INSERT INTO HistoClinicaFrms.$tablaMig (formato,tipoformato,id_historia,usuario,cargo,fecha,hora,cedula,ambito,unidadhosp,numservicio,compania,cerrado , noliquidacion,finalidadconsult,causaexterna,dx1,dx2,dx3,dx4,dx5,cmp00003,cmp00005,cmp00007,cmp00009,cmp00011,cmp00013, cmp00015, cmp00017, cmp00019, cmp00020, cmp00021, error) VALUES ('$formato','$tipoformato','$id_historia','$usuario_rm','$cargo','$fecha','$hora','$cedula','$ambito','$unidadhosp','$numservicio','$compania','$cerrado', '$noliquidacion','$finalidadconsult','$causaexterna','$dx1','$dx2','$dx3','$dx4','$dx5','$cmp00003','$cmp00005','$cmp00007','$cmp00009','$cmp00011','$cmp00013', '$cmp00015', '$cmp00017','$cmp00019','$cmp00020','$cmp00021', '$error')"	;
		...
		function insertarRegistroPostgresql($formato,$tipoformato,$id_historia,$usuario_rm,$cargo,$fecha,$hora,$cedula,$ambito,$unidadhosp,$numservicio,$compania,$cerrado , $noliquidacion,$finalidadconsult,$causaexterna,$dx1,$dx2,$dx3,$dx4,$dx5,$cmp00003,$cmp00005,$cmp00007,$cmp00009,$cmp00011,$cmp00013, $cmp00015, $cmp00017, $cmp00019, $cmp00020, $cmp00021) {
		//Realiza la insercion en Postgresql con base en los parametros
			global  $tablafrm;
			$cnx = 	conectar_postgres();
			$cons = "INSERT INTO HistoClinicaFrms.$tablafrm (formato,tipoformato,id_historia,usuario,cargo,fecha,hora,cedula,ambito,unidadhosp,numservicio,compania,cerrado , noliquidacion,finalidadconsult,causaexterna,dx1,dx2,dx3,dx4,dx5,cmp00003,cmp00005,cmp00007,cmp00009,cmp00011,cmp00013, cmp00015, cmp00017, cmp00019, cmp00020, cmp00021) VALUES ('$formato','$tipoformato','$id_historia','$usuario_rm','$cargo','$fecha','$hora','$cedula','$ambito','$unidadhosp','$numservicio','$compania','$cerrado', '$noliquidacion','$finalidadconsult','$causaexterna','$dx1','$dx2','$dx3','$dx4','$dx5','$cmp00003','$cmp00005','$cmp00007','$cmp00009','$cmp00011','$cmp00013', '$cmp00015', '$cmp00017','$cmp00019','$cmp00020','$cmp00021')"	;
			...
			function recorrerMatriz()  {
				...
				global $res,$matriz, $tablafrm;
					...
					if (mysql_num_rows($resPOS)>0){
						$cmp00007_1 = '<div align="center"><table width="100%" cellpadding="5" cellspacing="3" cellspacing="0" border="0" style="text-align:justify;font-size:11px">';
						$cmp00007_2 = "<tr> <td>PRINCIPIO ACTIVO </td> <td>POSOLOGIA</td> <td>PRESENTACION </td><td>DOSIS</td><td>CANTIDAD</td><td>TIEMPO EN MESES </td></tr>";
							while($POS = mysql_fetch_array($resPOS)){
								$principio = eliminarCaracteresEspFormatos($POS['Principio']);
								...
								$tiempo = eliminarCaracteresEspFormatos($POS['Tiempo']);
								
								$cmp00007_3 = $cmp00007_3."<tr><td>".$principio."</td><td>".$posologia."</td><td>".$presentacion."</td><td>".$dosis."</td> <td>".$cantidad ."</td> <td>".$tiempo."</td></tr>";
							}
						$cmp00007_4 = "</table></div>"	;	
						$cmp00007 = $cmp00007_1.$cmp00007_2.$cmp00007_3.$cmp00007_4;
					}
					else {
						$cmp00007 = 'NULL';					
					}
					...
					if (mysql_num_rows($resNoPOS)>0){
						$cmp00011_1 = '<div align="center"><table width="100%" cellpadding="5" cellspacing="3" cellspacing="0" border="0" style="text-align:justify;font-size:11px;">';
						$cmp00011_2 = "<tr> <td>PRINCIPIO ACTIVO </td> <td>POSOLOGIA</td> <td>PRESENTACION </td><td>DOSIS</td><td>CANTIDAD</td><td>TIEMPO EN MESES </td></tr>";
							while($NOPOS = mysql_fetch_array($resNoPOS)){
								$principio = eliminarCaracteresEspFormatos($NOPOS['Principio']);
								...
								$tiempo = eliminarCaracteresEspFormatos($NOPOS['Tiempo']);
								
								$cmp00011_3 = $cmp00007_3."<tr><td>".$principio."</td><td>".$posologia."</td><td>".$presentacion."</td><td>".$dosis."</td> <td>".$cantidad ."</td> <td>".$tiempo."</td></tr>";
							}
						$cmp00011_4 = "</table></div>"	;	
						$cmp00011 = $cmp00011_1.$cmp00011_2.$cmp00011_3.$cmp00011_4;
					}
					else {
						$cmp00011 = 'NULL';					
					}
		...
		global $tablafrm, $tipoformato , $formato ;			
			...
			echo "<div align='center'> <p class='mensajeFinalizacion'>Ha terminado la migracion del Formato 'FormatoNoPOSProcedimientos'</p> </div>";
		...
		if($_GET['formato']="FormatoNoPOSProcedimientos") {
		
				echo "<fieldset>";			
				echo "<legend> Migracion tabla MySQL </legend>";
				echo "<br>";
				echo "<span align='left'> <a href='../../index.php?migracion=MIG027' class = 'link1'> Panel de Administracion </a> </span>";
				echo "<br>";
				
				global $tablafrm, $tipoformato, $formato ;
				$tablafrm = "tbl00009";
				$tipoformato = "HISTORIA CLINICA";
				$formato = "FORMATO NO POS PROCEDIMIENTOS";
				$archivo = "Errores".$tablafrm.".html";
				eliminarRegistroVoBoxFormatos($tipoformato, $formato);
				migrarEstructuraFormato();
				//migrarRegistrosFormato();
				
					$totalMySQL = 0; // Se deja en cero por que no se migra información a este formato
