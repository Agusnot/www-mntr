...
<?
	...
	if($Tot!=0){echo "<em>Documentos descuadrados, ejecute revisi&oacute;n de integridad para detectarlos. Proceso Abortado!!!</em>";exit;}
	...
	if(ExNumRows($res2)>0){echo "<em>Existe movimiento sobre el comprobante de cierre para el periodo seleccionado, no es posible ejecutar el proceso!!!</em>";exit;}
?>
<input type="Hidden" name="ComprobanteDestino" value="<?echo $ComprobanteDestino?>">
<table cellpadding="6"  border="1" bordercolor="<?echo $Estilo[1]?>" style="font-family:<?echo $Estilo[8]?>;font-size:<?echo $Estilo[9]?>;font-style:<?echo $Estilo[10]?>">
<tr style="color:white;font-weight:bold" bgcolor="<?echo $Estilo[1]?>"><td>Comprobante</td><td>Debitos</td><td>Creditos</td><td>Diferencia</td></tr>
<?
