...
<body background="/Imgs/Fondo.jpg" onLoad="<? if($Mostrar){?>AbrirEstablecimientos('<? echo $Identificacion?>')<? }?>">
<style>
...
<tr style="font-weight:bold;color:<?echo $Estilo[6]?>;text-align:center" bgcolor="<?echo $Estilo[1]?>"><td></td><td></td><td>Identificacion</td><td>Nombre</td><td>Direccion</td><td>Regimen</td></tr>
<?
