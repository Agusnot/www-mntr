...
<td><a href="javascript:Reabrir('Debe')" class="For2">Debito</td>
<td><a href="javascript:Reabrir('Haber')" class="For2">Credito</td>
<td><a href="javascript:Reabrir('Tercero')" class="For2">Tercero</td>
