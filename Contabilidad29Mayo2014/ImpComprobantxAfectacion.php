<?
	...
	from Contabilidad.Movimiento where Comprobante='$Comprobante' and Numero='$Numero' and Compania='$Compania[0]' and Estado='AC' Order By Debe Desc";
	$res=ExQuery($cons);
...
<?
	...
	$Numero=substr("000000000",1,9-strlen($Numero))."$Numero";
