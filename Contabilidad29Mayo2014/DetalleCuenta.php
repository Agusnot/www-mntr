...
<tr><td class="Tit1">Codigo</td><td colspan="7">
<?
	if($Nuevo)
	{
		echo $Cuenta;
...
<strong>
Afectacion presupuestal:</strong>
...
<tr><td class="Tit1">Nombre</td><td colspan="7"><input style="width:400px;" type="Text" name="Nombre" value="<?echo $Nombre?>"></td></tr>
<tr><td class="Tit1">Naturaleza</td><td colspan="7">
...
<tr><td class="Tit1">Tipo</td><td colspan="7">
...
<tr><td class="Tit1">Centro de Costos</td><td>
<?
...
<td class="Tit1">Diferido</td>
<td>
<? if($fila['diferido']=='on'){?><input checked <? echo $Disab?> type="Checkbox" name="Diferido"><?}
else{?><input <? echo $Disab?> type="Checkbox" name="Diferido"><?}?>
</td>
<td class="Tit1">Tercero</td>
<td>
<? if($fila['tercero']==1){?><input checked <? echo $Disab?> type="Checkbox" name="Tercero"><?}
else{?><input <? echo $Disab?> type="Checkbox" name="Tercero"><?}?>
</td>

<td class="Tit1">Documentos</td>
...
<tr><td class="Tit1">Corriente</td><td>
...
<?	if($Banco=="1"){?>
	...
	<input type="Button" value="Cheque" onClick="open('FormaCheque.php?DatNameSID=<? echo $DatNameSID?>&Cuenta=<?echo $Cuenta?>','','width=800,height=250')">
	<input type="Button" value="Detalle Banco" onClick="AbrirBanco()">
	<?
	}?>
	...
	Exogena 1001</td>
	<td>
	<input type="text" name="Codigo1001" value="<?echo $Codigo1001?>" onClick="AbreExogena()"/></td>
</tr><?}?>
</table>
<br>
<?
...
<?if(!$Nuevo){
if($NumRecs==0){?>
<input type="Button" value="Eliminar" onClick="location.href='DetalleCuenta.php?DatNameSID=<? echo $DatNameSID?>&Eliminar=1&Cuenta=<?echo $Cuenta?>&CtaBuscar=<?echo $CtaBuscar?>'">
<?}
	if($Tipo=="Titulo")
	{
?>
...
<?
	...
	{?>
	<input type="Button" value="Afectaci&oacute;n Presupuestal" style="width:170px;" onClick="AbreAfectacionPptal();">
