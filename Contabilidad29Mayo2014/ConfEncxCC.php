...
<tr><td>Detalle</td><td><input type="text" name="Detalle" maxlength="80" style="width:250px;" value="<? echo $Detalle?>" onKeyUp="xLetra(this)" onKeyDown="xLetra(this)"></td></tr>
<tr><td>Tipo</td><td>
<select name="Tipo">
...
<? if($Nuevo || $Edit){?>
<tr><td colspan="2" align="center"><input type="submit" name="Guardar" value="Guardar">
