...
<tr style="color:<?echo $Estilo[6]?>;font-weight:bold;text-align:center" bgcolor="<?echo $Estilo[1]?>"><td>Id</td><td>Codigo</td><td>Debito</td><td>Cr&eacute;dito</td><td>Tercero</td><td>CC</td><td>Doc</td></tr>
<?
	...
	while($fila=ExFetch($res))
	{
		...
		echo "<tr bgcolor='$BG'><td align='right'>$fila[7]</td><td>$fila[0]</td><td align='right'>".number_format($fila[1],2)."</td><td align='right'>".number_format($fila[2],2)."</td><td align='right'>$fila[3]</td><td>$fila[4]</td><td>$fila[5]</td>";
		if($fila[8]==0){
...
<input type='Button' value='...' onClick="BuscarTerceros()"></td>
</td>
