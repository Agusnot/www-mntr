...
<title>Compuconta Software</title>
	<div style="text-align:center;position:absolute;top:10<? echo $fila['aniox']?>;left:10<?echo $fila['anioy']?>; font-size:12px"><?echo substr($fila1['fecha'],0,4)?></div>

	<div style="position:absolute;top:10<? echo $fila['mesx']?>;left:40<? echo $fila['mesy']?>;font-size:12px"><?echo substr($fila1['fecha'],5,2)?></div>

	<div style="position:absolute;top:10<? echo $fila['diax']?>;left:60<? echo $fila['diay']?>;font-size:12px"><?echo substr($fila1['fecha'],8,2)?></div>

	<div style="position:absolute;top:30<? echo $fila['valorx']?>;left:<? echo $fila['valory']?>;font-size:12px"><?echo number_format($Valor,2)?></div>

	<div style="position:absolute;top:50<? echo $fila['tercerox']?>;left:<? echo $fila['terceroy']?>;font-size:12px"><?echo $Tercero?></div>

	<div style="position:absolute;top:70<? echo $fila['letrasx']?>;left:<? echo $fila['letrasy']?>;font-size:12px"><?echo strtoupper($Letras)?></div>
    <?}?>
...
<?
	...
	$UsuarioCre=$fila[13];$Cheque=$fila[14];
?>
...
?>
<br><br><br>
<table border="0" bordercolor="#000000" cellspacing="1" width="100%" style=" text-transform:uppercase;font-family:<?echo $Estilo[8]?>;font-size:11;font-style:<?echo $Estilo[10]?>">
<tr valign="top"><td width="30%"><hr><? echo $Firmas['Representante'][0]."<br>".$Firmas['Representante'][1]?></td><td width="5%"></td><td width="30%"><hr><? echo $Firmas['Tesorero'][0]."<br>".$Firmas['Tesorero'][1]?></td><td width="5%"></td><td width="30%"><hr><? echo $NomBeneficiario?><br>ID</td></tr>
</table>
