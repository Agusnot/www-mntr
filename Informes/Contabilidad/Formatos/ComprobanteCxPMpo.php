<?
	...
	$Firmas=Firmas($Fecha,$Compania);
	$Cargo=$Firmas['Representante'][1];$NombreDirec=$Firmas['Representante'][0];
?>
...
<? echo strtoupper($Compania[0])?><br><br>
...
EL <?echo strtoupper($Cargo)?> DE <?echo strtoupper($Municipio)?>, en uso de sus atribuciones legales y constitucionales, en especial las conferidas en el Art. 91, Literal D, 
numeral 5 de la Ley 136 de 1994 y,<br><br>
<center><strong>
C O N S I D E R A N D O :<br><br></strong>
	</center>
Que dentro del presupuesto de Gastos de <?echo $Compania[0]?>, Vigencia <?echo $Anio?> existe una partida denominada:
...
<?
	...
	?>
		...
		<?
			...
			{
				$cons9="Select Nombre from Presupuesto.PlanCuentas where Cuenta='".$fila2['cuenta']."' and Anio=$Anio and  Vigencia='$Vigencia' and ClaseVigencia='$ClaseVigencia' and Compania='$Compania[0]'";
				$res9=ExQuery($cons9);
				$fila9=ExFetch($res9);
