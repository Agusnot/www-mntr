...
<?
	function Encabezados()
	{
		...
		<?echo $Compania[1]?><br>BALANCE DE PRUEBA POR TERCEROS<br>CORTE A: <?echo $PerFin?></td></tr>
		<tr><td colspan="10" style="text-align:center; font-weight: bold;" >FECHA DE IMPRESI&Oacute;N <?echo "$ND[year]-$ND[mon]-$ND[mday]"?></td>
		</tr>
		<tr>
		...
		<tr>
			<td class='encabezado2HorizontalInfCont' style='font-size:11px'>D&Eacute;BITO</td>
			<td class='encabezado2HorizontalInfCont' style='font-size:11px'>CR&Eacute;DITO</td>
			<td class='encabezado2HorizontalInfCont' style='font-size:11px'>D&Eacute;BITO</td>
			<td class='encabezado2HorizontalInfCont' style='font-size:11px'>CR&Eacute;DITO</td>
			<td class='encabezado2HorizontalInfCont' style='font-size:11px'>D&Eacute;BITO</td>
			<td class='encabezado2HorizontalInfCont' style='font-size:11px'>CR&Eacute;DITO</td>
...
<?	}
	...
	where Fecha<'$PerIni' and Compania='$Compania[0]' and Estado='AC'   and Cuenta>='$CuentaIni' and Cuenta<='$CuentaFin' 
	...
	where Fecha>='$PerIni' and Fecha<='$PerFin' and Compania='$Compania[0]' and Estado='AC' and Cuenta>='$CuentaIni' and Cuenta<='$CuentaFin'   and $ExcluyeComprobantes Group By Cuenta Order By Cuenta";
	//echo $cons3;
...
//////////////////MOVIMIENTOS///////////////////////
	...
	where Fecha>='$PerIni' and Fecha<='$PerFin' and Compania='$Compania[0]' and Estado='AC' and Cuenta>='$CuentaIni' and Cuenta<='$CuentaFin'   and $ExcluyeComprobantes 
...
////////DATOS DEL TERCERO/////////
	...
	if(!$PDF){
	echo "<tr>";
	echo "<td class='filaTotalesInfContable' style='text-align:right:right; padding-right: 10px;' colspan=4 align='right'>";
