...
<?
	function Encabezados()
	{
		...
		global  $borderTablaInfContable, $bordercolorTablaInfContable,  $cellspacingTablaInfContable, $cellpaddingTablaInfContable;
		?>
		<table  width="100%" class="tablaInformeContable" style="text-align:justify;" <?php echo $borderTablaInfContable; echo $bordercolorTablaInfContable; echo $cellspacingTablaInfContable; echo $cellpaddingTablaInfContable; ?>>
		<tr>
			<td colspan="10" style="text-align:center;font-weight:bold;"><?echo strtoupper($Compania[0])?><br>
				<?echo $Compania[1]?><br>BALANCE DE PRUEBA x TERCEROS<br>CORTE A: <?echo $PerFin?></td>
		</tr>
		<tr>
			<td colspan="10" style="text-align:center;font-weight:bold;">FECHA DE IMPRESI&Oacute;N <?echo "$ND[year]-$ND[mon]-$ND[mday]"?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class='encabezado2HorizontalInfCont'>D&Eacute;BITO</td>
			<td class='encabezado2HorizontalInfCont'>CR&Eacute;DITO</td>
			<td class='encabezado2HorizontalInfCont' colspan="2" >&nbsp;</td>
		</tr>
...
////////DATOS DEL TERCERO/////////
	...
	if(!$PDF){
	echo "<tr>";
		echo "<td colspan=4 class='filaTotalesInfContable' style='text-align:right; padding-right:10px;'>";
