		...
		<body <?php echo $backgroundBodyInfContableMentor;?>>
			<div class="divInformeContable" <?php echo $alignDivInformeContable;?>>
				...
				//			$CarteraSinSoporte[$fila3[3]][$fila3[4]][$Periodo][$fila3[1]]=array($CarteraSinSoporte[$fila3[3]][$fila3[4]][$Periodo][$fila3[1]][0]+$fila3[0],$fila3[1],$fila3[2]);
					...
					{
						echo "<tr><td class='encabezado3HorizontalInfCont' colspan=5><strong>$fila[0] $fila[1]</td></tr>";
						...
						{?>
							...
							for($i=0;$i<=count($Dias)-1;$i++)
							{
								if(count($MatCartera[$fila[0]][$Ident[0]][$i])>0)
								{
									...
									{
										echo "<tr>";
											echo "<td class='encabezado2HorizontalInfCont' colspan=3 align='center'><font size=3>".$DetDias[$i]."</td>";
										echo "</tr>";
										echo "<tr>";
											echo "<td class='encabezado2HorizontalInfContInv'>FECHA </td>";
											echo "<td class='encabezado2HorizontalInfContInv'>DOCUMENTO</td>";
										...
										foreach($MatCartera[$fila[0]][$Ident[0]][$i] as $Documento)
										{
											if($Documento[0]>0)
											{
												echo "<tr>";
													...
													echo "<td>".number_format($Documento[0],2)."</td>";
												echo "</tr>";
											}
										}
										echo "<tr>";
											echo "<td  class='filaTotalesInfContable' style='text-align:right;padding-right:10px;'colspan=2>";
												echo "TOTAL PERIODO";
											echo "</td>";
											echo "<td class='filaTotalesInfContable'>".number_format($TotPeriodo[$i],2)."</td>";
										echo "</tr>";
								...
								{
									echo "<tr>";
										echo "<td style='color:red'><strong>CREDITOS SIN REFERENCIA</td></tr>";
									echo "<tr>";
										echo "<td class='encabezado2HorizontalInfContInv'>FECHA</td>";
										echo "<td class='encabezado2HorizontalInfContInv'>DOCUMENTO</td>";
										echo "<td class='encabezado2HorizontalInfContInv' >SALDO</td>";
							...
							echo "<tr>";
								...
								echo "<td class='filaTotalesInfContable'>".number_format($TotEntidad,2)."</td></tr>";
						...
						echo "<tr>";
							...
							echo "<td class='filaTotalesInfContable'>".number_format($TotCartera,2)."</td></tr>";
					}
					echo "</table>";
				?>
			</div>	
