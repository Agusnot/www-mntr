...
?>
			<head>
				...
				<script language="javascript">
					...
					function Ocultar()
					{
						parent.document.getElementById('Reporteador').rows="80,*"; // SE VUELVE EL FRAME PRINCIPAL AL TAMAÑO NORMAL
			...
			<body <?php echo $backgroundBodyMentor; ?> onFocus="Ocultar()">
				<?php
				...
				<div <?php echo $alignDiv2Mentor; ?>	
						<table>
							<tr>
								<td>
									
									<table class="tabla2" style="text-align:left; margin-top:15px;margin-bottom:15px;"  <?php echo $borderTabla2Mentor; echo $bordercolorTabla2Mentor; echo $cellspacingTabla2Mentor; echo $cellpaddingTabla2Mentor; ?> onFocus="Ocultar()">
										<tr>
						...
						<table width="95%"class="tabla2" style="text-align:left;"  <?php echo $borderTabla2Mentor; echo $bordercolorTabla2Mentor; echo $cellspacingTabla2Mentor; echo $cellpaddingTabla2Mentor; ?>  >
						<?
							if($Seleccion){
							$cons="Select Tipo,Archivo from Central.Reportes where Nombre='$Seleccion'  and Modulo='Contabilidad'";
							$res=ExQuery($cons);
							$fila=ExFetch($res);
							$Tipo=$fila[0];
							$NomArchivo=$fila[1];
							...
							if($Tipo==1){
								...
								echo "<tr>";
									echo "<td colspan=2 class='encabezado2Horizontal'><center>PERIODO</td>";
								...
								echo "<tr>";
									echo "<td>";
										...
										<?		
										echo "<td>";
											echo "<input  type='Checkbox' name='IncluyeCeros' onFocus='Ocultar()'>";
										echo "</td>";
										echo "<td>";
											echo "<input type='Text' name='NoDigitos' style='width:20px;' onFocus='Ocultar()' value=$NoDigitos>";
										echo "</td>";
										?>
										<td>
											<input type="Text" name="CuentaIni" style="width:70px;" onFocus="Mostrar();BuscarCuenta(this.name,this.value)" onKeyDown="BuscarCuenta(this.name,this.value)" onKeyUp="BuscarCuenta(this.name,this.value)" onBlur="CuentaFin.value=CuentaIni.value" value="<? echo $CuentaIni?>">
										</td>
										<td>
											<input type="Text" name="CuentaFin" style="width:70px;" value="<? echo $CuentaFin?>" onFocus="Mostrar();BuscarCuenta(this.name,this.value)" onKeyDown="BuscarCuenta(this.name,this.value)" onKeyUp="BuscarCuenta(this.name,this.value)">
										</td>
										<td>
											<input type="Text" name="CC" style="width:60px;" value="<? echo $CC?>" onFocus="Mostrar();BuscarCC(this.name,this.value)" onKeyDown="BuscarCC(this.name,this.value)" onKeyUp="BuscarCC(this.name,this.value)">
										</td>
										<td>
							...
							if($Tipo==2){
								echo "<form name='FORMA' action='$NomArchivo' target='Abajo'>";
									...
									echo "<tr>";
										...
										echo "</td>";?>
										<td>
											<input type='Text' name='CuentaIni' style='width:70px;' value="<? echo $CuentaIni?>"onFocus="Mostrar();BuscarCuenta(this.name,this.value)" onKeyDown="BuscarCuenta(this.name,this.value)" onKeyUp="BuscarCuenta(this.name,this.value)" onBlur="CuentaFin.value=CuentaIni.value">
										</td>
										<td>
											<input type='Text' name='CuentaFin' style='width:70px;' value="<? echo $CuentaFin?>" onFocus="Mostrar();BuscarCuenta(this.name,this.value)" onKeyDown="BuscarCuenta(this.name,this.value)" onKeyUp="BuscarCuenta(this.name,this.value)">
										</td>	
										<?
										echo "<td>";
											echo "<input type='Checkbox' name='PDF' onFocus='Ocultar()'>";
										echo "</td>";
							}
						...
						<?
							...
							if($Tipo==4){
								echo "<form name='FORMA' action='$NomArchivo' target='Abajo'>";
								echo "<tr>";
									echo "<td class='encabezado2Horizontal'><center>CORTE</td>";
									echo "<td class='encabezado2Horizontal'>DIGITOS</td>";?>
								<tr><td>
								<select name="Anio" onFocus='Ocultar()'><?
								for($i=$AnioInc;$i<$AnioAf;$i++)
						...
						<?		echo "<td><input type='Text' name='NoDigitos' onFocus='Ocultar()' style='width:70px;' value=$NoDigitos></td>";
							...
							if($Tipo==5){
								echo "<form name='FORMA' action='$NomArchivo' target='Abajo'>";
								echo "<tr>";
									echo "<td class='encabezado2Horizontal'><center>MES</td>";
									echo "<td class='encabezado2Horizontal'><center>A&Ntilde;O</td>";
						...
						<?	}
							if($Tipo==6){
								echo "<form name='FORMA' action='$NomArchivo' target='Abajo'>";
								echo "<tr>";
									echo "<td class='encabezado2Horizontal'><center>PERIODO INICIAL</td>";
							...
							if($Tipo==7){
								echo "<form name='FORMA' action='$NomArchivo' target='Abajo'>";
								echo "<tr>";
									echo "<td class='encabezado2Horizontal' colspan=2><center>CORTE</td>";
									echo "<td class='encabezado2Horizontal'>CUENTA INICIAL</td>";
									echo "<td class='encabezado2Horizontal'>CUENTA FINAL</td>";
									echo "<td class='encabezado2Horizontal'>TERCERO</td>";
								...
								<td><input type='Text' name='Tercero' style='width:60px;' value="<? echo $Tercero?>" onFocus="Mostrar();BuscarTercero(this.name,this.value)" onKeyUp="BuscarTercero(this.name,this.value)" onKeyDown="BuscarTercero(this.name,this.value)">
						<?
								echo "<td><input type='checkbox' name='MostrarDocs'><input type='Text' name='NoDoc' style='width:40px;'></td>";
						...
						<?
							...
							if($Tipo==9){
								echo "<form name='FORMA' action='$NomArchivo' target='Abajo'>";
								echo "<tr>";
									echo "<td class='encabezado2Horizontal' colspan=2><center>VIGENCIA</td>";?>
								<tr><td>
								<select name="Anio" onFocus='Ocultar()'><?
								for($i=$AnioInc;$i<$AnioAf;$i++)
								if($i==$AnioAc){echo "<option selected value=$i>$i</option>";}
						...
						<td><input type="Submit" name="Ver" value="Ver reporte" class="boton2Envio" onFocus="Ocultar()"></td>
						</table>
						</form>
						<iframe id="Busquedas" name="Busquedas" style="display:none;" src="/Contabilidad/Busquedas.php?DatNameSID=<? echo $DatNameSID?>&" frameborder="0" height="220"></iframe>
				</div>
			</body>