	...
	<html>	
		...
		<?
			function Encabezados(){
				...
				?>
				<table  rules="groups" class="tablaInformeContable"  width="100%"  style="text-align:justify;" <?php echo $borderTablaInfContable; echo $bordercolorTablaInfContable; echo $cellspacingTablaInfContable; echo $cellpaddingTablaInfContable; ?> >
				<tr>
					<td colspan="8" style="text-align:center;font-weight: bold;"><?echo strtoupper($Compania[0])?><br>
						<?echo $Compania[1]?><br>ESTADO DE RESULTADOS<br>ENTRE  <? echo $PerIni ?> A <? echo $PerFin?></td>
				</tr>
				<tr>
					<td colspan="8" style="text-align:center;font-weight: bold;">FECHA DE IMPRESI&Oacute;N <?echo "$ND[year]-$ND[mon]-$ND[mday]"?></td>
				</tr>				
				<tr>
