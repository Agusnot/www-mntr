...
<?
	function Encabezados()
	{
		...
		<?echo $Compania[1]?><br>LIBRO MAYOR Y BALANCE <br> DIGITOS: <? echo $NoDigitos?> <br>Corte a: <?echo $PerFin?></strong></center></td></tr>
		...
		?>
		<td rowspan="2">Descripci&oacute;n</td><td colspan="2">Saldo Anterior</td><td colspan="2">Movimientos del Periodo</td><td colspan="2">Saldo Final</td></tr>
...
if(!$PDF){
	...
	echo "<td align='right' colspan=2><strong>SUMAS IGUALES</td>";
