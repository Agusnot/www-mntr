...
<?
	...
	function Encabezados()
	{
		...
		?>
		<td rowspan="2">Descripcion</td><td colspan="2">Saldo Anterior</td><td colspan="2">Movimientos del Periodo</td><td colspan="2">Saldo Final</td></tr>
...
<?	}
	...
	where Fecha<'$PerIni' and Compania='$Compania[0]' and Estado='AC'   and $ExcluyeComprobantes and
	...
	where Fecha>='$PerIni' and Fecha<='$PerFin' and Compania='$Compania[0]' and Estado='AC'   and $ExcluyeComprobantes and
	Cuenta>='$CuentaIni' and Cuenta<='$CuentaFin'  $CondCC
