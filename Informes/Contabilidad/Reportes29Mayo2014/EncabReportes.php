...
<?
	...
	if($Tipo==1)
	{
		...
		echo "<tr bgcolor='#e5e5e5' align='center'><td colspan=2><center>Perido</td><td>Ceros</td><td>Dig</td><td>Cuenta Inicial</td><td>Cta Final</td><td>CC</td><td>PDF</td>";?>
		<tr><td>
...
<?
	...
	{
		echo "<form name='FORMA' action='$NomArchivo' target='Abajo'>";
		echo "<tr bgcolor='#e5e5e5' align='center'><td><center>Corte</td><td>Ceros</td><td>No. Digitos</td><td>Cuenta Inicial</td><td>Cta Final</td><td>PDF</td>";?>
...
<?
	...
	{
		echo "<form name='FORMA' action='$NomArchivo' target='Abajo'>";
		echo "<tr bgcolor='#e5e5e5' align='center'><td colspan=2><center>Perido</td><td>Dig</td><td>Cuenta Inicial</td><td>Cta Final</td><td>Tercero</td><td>Comprobante</td><td>CC</td><td>PDF</td>";
		?>
		<tr>
		<td>
		<select name="Anio" onFocus='Ocultar()'><?
...
<?		echo "<td><input type='Text' name='NoDigitos' onFocus='Ocultar()' style='width:70px;' value=$NoDigitos></td>";
	...
	{
		echo "<form name='FORMA' action='$NomArchivo' target='Abajo'>";
		echo "<tr bgcolor='#e5e5e5' align='center'><td><center>Mes</td><td><center>A&ntilde;o</td><td>Banco</td>";
		echo "<tr><td>
...
<?	}
	...
	{
		echo "<form name='FORMA' action='$NomArchivo' target='Abajo'>";
		echo "<tr bgcolor='#e5e5e5' align='center'><td><center>Periodo Inicial</td><td>Periodo Final</td>";
		?>
		<tr><td>
		<select name="Anio" onFocus='Ocultar()'><?
		for($i=$AnioInc;$i<$AnioAf;$i++)
	...
	{
		echo "<form name='FORMA' action='$NomArchivo' target='Abajo'>";
		echo "<tr align='center'><td colspan=2><center>Corte</td><td>Cuenta Inicial</td><td>Cta Final</td><td>Tercero</td><td>Documentos</td>";
		?><tr><td>
		<select name="Anio" onFocus='Ocultar()'><?
		for($i=$AnioInc;$i<$AnioAf;$i++)
		if($i==$AnioAc){echo "<option selected value=$i>$i</option>";}
...
<?
	...
	{
		echo "<form name='FORMA' action='$NomArchivo' target='Abajo'>";
		echo "<tr align='center'><td colspan=2><center>Perido</td><td>No. Digitos</td><td>Cuenta Inicial</td><td>Cta Final</td><td>Agrupado x</td>";
...
<?
	...
	{
		echo "<form name='FORMA' action='$NomArchivo' target='Abajo'>";
		echo "<tr align='center'><td colspan=2><center>Vigencia</td>";?>
		<tr><td>
		<select name="Anio" onFocus='Ocultar()'><?
		for($i=$AnioInc;$i<$AnioAf;$i++)
		if($i==$AnioAc){echo "<option selected value=$i>$i</option>";}
	...
	{
		echo "<form name='FORMA' action='$NomArchivo' target='Abajo'>";
		echo "<tr bgcolor='#e5e5e5' align='center'><td colspan=2><center>Perido</td><td>Tercero</td><td>Comprobante</td>";
		?>
		<tr>
		<td>
		<select name="Anio" onFocus='Ocultar()'><?
...
<td><input type="Submit" name="Ver" value="Ver" onFocus="Ocultar()"></td>
</table>
</form>
