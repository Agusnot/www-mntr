...
<table border="1" rules="groups" bordercolor="#ffffff" style="font-family:'<?echo $Estilo[8]?>';font-size:11;font-style:'<?echo $Estilo[10]?>'">
<tr><td colspan="7">
<?
...
<strong>Valor Extracto:</strong> <input type="Text" style="text-align:right; border:0px; width:90px; font-size:11px"   name="VrExtracto" value="<?echo $SaldoExtracto?>">
...
<?
	...
	while($fila=ExFetch($res))
	{
		...
		while($fila1=ExFetch($res1))
		{
			...
			echo "<tr bgcolor='$BG'><td>$fila1[0]</td><td align='right'>$fila1[1]$Msj</td><td align='right'>$fila1[2]</td><td>$fila1[3] $Tercero</td>";
...
<tr><td colspan="7" align="right"><input type="Submit" name="Guardar" value="Guardar"></td></tr>
</form>
</table>
<font size="2">
