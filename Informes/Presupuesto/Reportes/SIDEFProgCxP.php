...
<?echo $Compania[1]?><br><br><br>SIDEF<br>PROGRAMACION DE RESERVA PRESUPUESTAL<br>
...
<?
	...
	Encabezados();
	if($Anio){
	$Vigencia="Anteriores";$ClaseVigencia="CxP";
	ExQuery("Delete from SIDEF");
	$cons="Select Cuenta,Nombre,length(Cuenta) as Digitos,SIDEF,Rec,SREc,NomSIDEF from PlanCuentas where Cuenta like '2%' 
	and Tipo='Detalle' and SIDEF!='' and Anio=$Anio and Vigencia='$Vigencia' and ClaseVigencia='$ClaseVigencia' Order By SIDEF";
	$res=ExQuery($cons);
