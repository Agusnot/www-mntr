...
<tr bgcolor="#e5e5e5" align="center"><td rowspan="2">Codigo</td><td rowspan="2">Nombre</td><td rowspan="2">Apropiaci&oacute;n Inicial</td><td colspan="2">Modificaciones</td><td rowspan="2">Apropiaci&oacute;n Definitiva</td><td colspan="2">Reconocimiento</td><td>Recaudos</td><td rowspan="2">Saldo Apropiacion</td>
<tr bgcolor="#e5e5e5" align="center"><td>Adiciones</td><td>Reducciones</td><td>Totales</td><td>Sin Afectacion</td><td>Totales</td></tr>
...
<?
	...
	while($fila=ExFetch($res))
	{
		...
		echo "<td align='right'>".number_format($TotReconoc,2)."</td><td align='right'>".number_format($ReconocSinAfectar,2)."</td><td align='right'>".number_format($IngTotales,2)."</td>
