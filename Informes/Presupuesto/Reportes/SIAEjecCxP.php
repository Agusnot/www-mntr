<?
	...
	$ClaseVigencia=="CxP";$Vigencia="Anteriores";
...
?>
	...
	<?echo $Compania[1]?><br>S.I.A. Ejecución de Gastos de Cuentas x Pagar<br>Periodo: <?echo "$MesIni a $MesFin de $Anio"?></td></tr>
...
<?
	...
	$cons="Select Cuenta,Nombre,SIA from Presupuesto.PlanCuentas where Cuenta like '2%' and Tipo='Detalle' and Anio=$Anio and Vigencia='Anteriores' and ClaseVigencia='CxP' and Compania='$Compania[0]' Order By Cuenta";
	$res=ExQuery($cons);
