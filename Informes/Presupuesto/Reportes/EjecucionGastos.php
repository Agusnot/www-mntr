...
<tr bgcolor="#e5e5e5" align="center"><td rowspan="2">Codigo</td><td rowspan="2">Nombre</td><td rowspan="2">Apropiacion Inicial</td><td colspan="4">Modificaciones</td><td rowspan="2">Apropiación Definitiva</td><td colspan="2">Disponibilidades</td><td colspan="2">Compromisos</td><td colspan="2">Obligaciones</td><td rowspan="2">Pagos</td><td rowspan="2">Saldo Disponible</td>
<tr bgcolor="#e5e5e5" align="center"><td>Adiciones</td><td>Reducciones</td><td>Creditos</td><td>Contra Creditos</td><td>Totales</td><td>Sin Afectacion</td><td>Totales</td><td>Sin Afectacion</td><td>Totales</td><td>Sin Afectacion</td></tr>
<?
	}
	Encabezados();
	if($Anio){
	...
	while($fila=ExFetch($res))
	{
		...
		echo "<td align='right'>".number_format($TotDispo,2)."</td><td align='right'>".number_format($DispoSinAfecta,2)."</td><td align='right'>".number_format($TotCompromisos,2)."</td>
		<td align='right'>".number_format($CompromisosSinAfecta,2)."</td><td align='right'>".number_format($TotObligaciones,2)."</td><td align='right'>".number_format($ObligacSinAfectar,2)."</td>
		<td align='right'>".number_format($Egresos,2)."</td><td align='right'>".number_format($SaldoDispo,2)."</td>";
		$NumRec++;
