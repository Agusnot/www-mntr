...
<?
	...
	and Movimiento.Vigencia='Anteriores' and Movimiento.ClaseVigencia='CxP'
	...
	$cons="Select Fecha,Movimiento.Cuenta,DocOrigen,NoDocOrigen,Movimiento.Identificacion,Detalle,Credito,PrimApe,SegApe,PrimNom,SegNom,SIA,Movimiento.Comprobante,Numero,PlanCuentas.Nombre,CompAfectado,DocSoporte
	...
	and Movimiento.Vigencia='Anteriores' and Movimiento.ClaseVigencia='CxP'
	and PlanCuentas.Vigencia='Anteriores' and PlanCuentas.ClaseVigencia='CxP'
	...
	while($fila=ExFetch($res))
	{
		...
		$cons19="Select Credito from Presupuesto.Movimiento where Comprobante='$fila[15]' and Numero='$fila[16]' and Identificacion='$fila[4]' and Movimiento.Anio=$Anio and Estado='AC' and Cuenta='$fila[1]'
		and Movimiento.Compania='$Compania[0]'";
		...
		echo "<tr><td><strong>$fila[11]</strong>$fila[1]</td><td>$fila[14]</td><td align='right'>".number_format($fila19[0],2)."</td><td>$fila[0]</td><td>$fila[3]</td><td>$Tercero</td><td>$fila[4]</td><td>".$fila[5]."</td><td align='right'>".number_format($fila[6],2)."</td>";
