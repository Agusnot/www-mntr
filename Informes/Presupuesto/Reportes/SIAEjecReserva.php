<?
	...
	$ClaseVigencia=="Reservas";$Vigencia="Anteriores";
...
?>
	...
	<?echo $Compania[1]?><br>S.I.A. Ejecución de Gastos de Reserva Presupuestal<br>Periodo: <?echo "$MesIni a $MesFin de $Anio"?></td></tr>
...
<?
	...
	$cons="Select Cuenta,Nombre,SIA from Presupuesto.PlanCuentas where Cuenta like '2%' and Tipo='Detalle' and Anio=$Anio and Vigencia='Anteriores' and ClaseVigencia='Reservas' and Compania='$Compania[0]' Order By Cuenta";
	$res=ExQuery($cons);
	while($fila=ExFetch($res))
	{
		...
		echo "<tr><td><strong>$fila[2]</strong>$fila[0]</td><td>".substr($fila[1],0,40)."</td><td>ND</td>
