<?
    ...
    from Salud.PlantillaMedicamentos,Consumo.CodProductos Where Autoid=AutoidProd and Control='No'
    ...
    while($fila = ExFetch($res))
    {
        ...
        if(eregi("desde",$fila[6]))
        {
            $fila[6] = substr($fila[6],0,stripos($fila[6],"desde"));
        }
    ...
    and CodProductos.Control = 'No' and CodProductos.Estado = 'AC' and Movimiento.Estado = 'AC'
    and Movimiento.AlmacenPpal = '$AlmacenPpal' and Movimiento.Anio = $Anio and Fecha >= '$FechaIni'
    and Fecha <='$FechaFin' and TipoComprobante = 'Salidas' and CodProductos.Anio = $Anio and idsolicitud is null
    $AdConsAutoId $AdconsPaciente3
    order by Numero,NombreProd1,UnidadMedida,Presentacion,Fecha,
...
<body>
    ...
    while($fila = ExFetch($res))
    {
        ...
        <table border="0" bordercolor="#e5e5e5" width="70%"
            ...
            <tr>
                <td align="center"><b>Formula de Prescripcion de medicamentos</b></td>
            </tr>
            <tr>
                <td colspan="3">
