...
/////////////////////////////////DEVOLUCIONES/////////////////////////////////
    ...
    while($fila = ExFetch($res))
    {
        ...
        if(!$Devolucion[$fila[0]][$fila[3]]){$Devolucion[$fila[0]][$fila[3]] = $fila[4];}
        else{$Devolucion[$fila[0]][$fila[3]] = $Devolucion[$fila[0]][$fila[3]] + $fila[4];}
...
class PDF extends PDF_Rotate
{
    function BasicTable($Medicamentos,$Plantilla)
    {
        ...
        global $Dispensa; global $CedulaD; global $DiasMes; global $Anio; global $MesFin; global $Devolucion;
        ...
        //{
            while(list ($Identificacion,$Medicamentos2) = each ($Medicamentos))
            {
                ...
                if($DatPaciente[$Identificacion][6][0]=="F"){$this->Cell(5,5,"",0,0,'L');$this->Cell(5,5,"X",0,0,'C');}
                if($DatPaciente[$Identificacion][6][0]=="M"){$this->Cell(17,5,"",0,0,'L');$this->Cell(5,5,"X",0,0,'C');}
                $this->Ln(8);
                ///////////////////////////////////////////////////////////////////
...
//                }
                ...
                while(list($AutoId,$Medicamentos3) = each($Medicamentos2))
                {
                    ...
                    $this->Cell(14,5,$Medicamentos3[1]-$Devolucion[$Identificacion][$AutoId],0,0,'L');
                    $this->Ln(2);
                }
                $this->SetFont('Arial','',7);
                $this->AddPage();
