...
<form name="FORMA">
    ...
    {
        $cons1 = "Select Nombre,Codigo,VrUnidad,Cantidad,generico
        ...
        while($fila1 = ExFetch($res1))
        {
            ...
            if($fila2[0])
            {
                ...
                $RegSISMED[$fila[3]][$fila2[0]]['VrTotal'] = $RegSISMED[$fila[3]][$fila2[0]]['VrTotal'] + ($fila1[2]*$fila1[3]);
                $RegSISMED[$fila[3]][$fila2[0]]['CantTotal'] = $RegSISMED[$fila[3]][$fila2[0]]['CantTotal'] + $fila1[3];
                $CANTMEDICAMENTOS = $CANTMEDICAMENTOS + $fila1[3];
                $SUMVRMEDICAMENTOS = $SUMVRMEDICAMENTOS + ($fila1[2]*$fila1[3]);
