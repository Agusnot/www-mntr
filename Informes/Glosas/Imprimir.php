					...
					if(document.FORMA.FacF.value!=""){
						if(document.FORMA.FacI.value==""){
							...
							if(parseInt(document.FORMA.FacI.value)>parseInt(document.FORMA.FacF.value)){
								...
								frames.RepImprimir.location.href='RepImprimir.php?DatNameSID=<? echo $DatNameSID?>&Entidad=<? echo $Entidad?>&FechaIni='+document.FORMA.FechaIni.value+'&FechaFin='+document.FORMA.FechaFin.value+'&Contrato=<? echo $Contrato?>&NoContrato=<? echo $NoContrato?>&Ver=1&FacI='+document.FORMA.FacI.value+'&FacF='+document.FORMA.FacF.value;
							}
						}
					}
					else{									
...
<iframe frameborder="0" id="RepImprimir" src="RepImprimir.php?DatNameSID=<? echo $DatNameSID?>&Entidad=<? echo $Entidad?>&FechaIni=<? echo $FechaIni?>&FechaFin=<? echo $FechaFin?>&Contrato=<? echo $Contrato?>&NoContrato=<? echo $NoContrato?>" width="100%" height="85%"></iframe>    
</body>
</html>
