					...
					if(document.FORMA.FacF.value!=""){
						if(document.FORMA.FacI.value==""){
							...
							if(parseInt(document.FORMA.FacI.value)>parseInt(document.FORMA.FacF.value)){
								...
								frames.RepRadicas.location.href='RepRadicas.php?DatNameSID=<? echo $DatNameSID?>&Entidad=<? echo $Entidad?>&FechaIni='+document.FORMA.FechaIni.value+'&FechaFin='+document.FORMA.FechaFin.value+'&Contrato=<? echo $Contrato?>&NoContrato=<? echo $NoContrato?>&Ver=1&FacI='+document.FORMA.FacI.value+'&FacF='+document.FORMA.FacF.value;
							}
						}
					}
					else{									
						if(document.FORMA.FacI.value!=""){
							if(document.FORMA.FacF.value!=""){																					
								if(document.FORMA.FacI.value>document.FORMA.FacF.value){	
									...
									frames.RepRadicadas.location.href='RepRadicadas.php?DatNameSID=<? echo $DatNameSID?>&Entidad=<? echo $Entidad?>&FechaIni='+document.FORMA.FechaIni.value+'&FechaFin='+document.FORMA.FechaFin.value+'&Contrato=<? echo $Contrato?>&NoContrato=<? echo $NoContrato?>&Ver=1&FacI='+document.FORMA.FacI.value+'&FacF='+document.FORMA.FacF.value;																					
								}
							}
							else{
								frames.RepRadicadas.location.href='RepRadicadas.php?DatNameSID=<? echo $DatNameSID?>&Entidad=<? echo $Entidad?>&FechaIni='+document.FORMA.FechaIni.value+'&FechaFin='+document.FORMA.FechaFin.value+'&Contrato=<? echo $Contrato?>&NoContrato=<? echo $NoContrato?>&Ver=1&FacI='+document.FORMA.FacI.value+'&FacF='+document.FORMA.FacF.value;																					
...
<table BORDER=1  style='font : normal normal small-caps 12px Tahoma;' border="1" bordercolor="#e5e5e5" cellpadding="2" align="center">  
	<tr align="center">	
        <td colspan="8" bgcolor="#e5e5e5" style="font-weight:bold">FACTURAS RADICADAS</td>
...
<iframe frameborder="0" id="RepRadicadas" src="RepRadicadas.php?DatNameSID=<? echo $DatNameSID?>&Entidad=<? echo $Entidad?>&FechaIni=<? echo $FechaIni?>&FechaFin=<? echo $FechaFin?>&Contrato=<? echo $Contrato?>&NoContrato=<? echo $NoContrato?>" width="100%" height="85%"></iframe>    
</body>
</html>
