...
<table BORDER=1  style='font : normal normal small-caps 12px Tahoma;' border="1" bordercolor="#e5e5e5" cellpadding="2" align="center">  
	<tr bgcolor="#e5e5e5" style="font-weight:bold" align="center">    	
    	<td colspan="12">Recepción de Glosas</td>
	</tr>
     <tr>    	
     	<?
        if(!$FechaIni){
...
<? if($Ver){?>
<iframe frameborder="0" id="Verglosas" src="glosar.php?DatNameSID=<? echo $DatNameSID?>&FechaIni=<? echo $FechaIni?>&FechaFin=<? echo $FechaFin?>&Entidad=<? echo $Entidad?>&Contrato=<? echo $Contrato?>&NoContrato=<? echo $NoContrato?>&Desde=<? echo $Desde?>&Hasta=<? echo $Hasta?>" width="100%" height="85%">
</iframe>
<? }?>
</body>
</html>
