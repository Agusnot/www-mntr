...
//	echo $CodArp;
	if($Guardar)
	{
		...
		if(ExNumRows($res)==0)
		{			
			$cons="insert into nomina.idcompania (compania,identificacion,codigo,claseaportante,naturajuridica,tipopersona,actividadeconomica) values ('$Compania[0]','$Arp','$CodArp','$Aportante','$NatJuri','$TipoPer','$CodActEco')";
			$res=ExQuery($cons);
