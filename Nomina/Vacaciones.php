<?php
	...
	if($Guardar)
	{
		...
		$cons="insert into nomina.vacaciones (compania,identificacion,concepto,fecinicio,fecfinal,dias,detalle,resolucion,autorizacion,usuario,fecha,estado,numero) values ('$Compania[0]','$Identificacion','$RegNomina','$FecInicio','$FecFinal',$Dias,'$Detalle','$Resolucion','$Autorizacion','$usuario[1]','$Fec','$Estado','$Numero')";
		$res=ExQuery($cons);
		$cons="select movimiento,claseconcepto,detconcepto from nomina.conceptosliquidacion where concepto='$RegNomina'";
//		$res=ExQuery($cons);
		?>
        <script>alert("La Vacacion ha sido Guardada !!!");
...
<tr>
	<td colspan="6" colspan=4 bgcolor="#666699" style="color:white" align="center">VACACIONES</td>
</tr>
<tr>
