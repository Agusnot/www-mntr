<?	if($DatNameSID){session_name("$DatNameSID");}
	...
	{			
		if($Edit)
		{	
			$cons="Update Central.Terceros set Identificacion='$Identificacion',Primape='$Primape',Direccion='$Direccion',Telefono='$Telefono',Replegal='$Replegal',Codigosgsss='$Codigosgsss',Nomcontacto='$Nomcontacto',Telcontacto='$Telcontacto',Notas='$Notas',tipoasegurador='$TipoAseguramiento' where Identificacion='$IdentificacionAnt' and Compania='$Compania[0]'";
		}		
		//echo $cons;
