<?	if($DatNameSID){session_name("$DatNameSID");}
	...
	{			
	    ...
	    location.href='Cesantias.php?DatNameSID=<? echo $DatNameSID?>&Idant=<? echo $Idant?>&Nombre=<? echo $Nombre?>';
       	</script>        
	     <?
	}
...
<table border="1" bordercolor="#e5e5e5" style='font : normal normal small-caps 12px Tahoma;' align="center" width="50%">
    ...
    <tr>
    	<td align="center" colspan="11"><input type="submit" name="Guardar" value="Guardar"><input type="button" name="Cancelar" value="Cancelar" onClick=" location.href='Cesantias.php?DatNameSID=<? echo $DatNameSID?>&Idant=<? echo $Idant?>&Nombre=<? echo $Nombre?>';"></td>
    </tr>
</table>
