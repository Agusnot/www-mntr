    ...
    <table width="200" border="1" cellpadding="5" bordercolor="#DDDDDD" background="../Imgs/Fondo.jpg" bgcolor="#FFFFFF">
      <tr>
        <td colspan="8" nowrap="nowrap"><table width="200" align="left" cellpadding="5">
          <tr>
            <td nowrap="nowrap"><div align="left"><strong>APERTURA DE HISTORIAS  </strong></div></td>
            </tr>
          <tr>
      ...
      <tr>
        ...
        <td nowrap="nowrap" bgcolor="#EEEEEE"><strong>USUARIO CREADOR </strong></td>
        <td nowrap="nowrap" bgcolor="#EEEEEE"><strong>FECHA CREACI&Oacute;N </strong></td>
        <td nowrap="nowrap" bgcolor="#EEEEEE"><strong>USUARIO MOD </strong></td>
        <td nowrap="nowrap" bgcolor="#EEEEEE"><strong>USUARIO INGRESO </strong></td>
      </tr>
	   <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
...
FROM
	...
	central.terceros
WHERE
	servicios.cedula = terceros.identificacion
	and  estado = 'AC'
	and  tipo = 'Paciente'
...
echo'<tr>
        ...
        <td height="10">'.$fila[2].' '.$fila[3].' '.$fila[4].' '.$fila[5].'</td>
