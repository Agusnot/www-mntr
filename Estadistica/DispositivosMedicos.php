...
<form name="FORMA" method="post">
    ...
    <?
	$cons ="SELECT consumo.codproductos.codigo1, consumo.codproductos.nombreprod1, consumo.codproductos.presentacion, consumo.codproductos.unidadmedida, consumo.codproductos.riesgo,lote, vence, 
...
AND consumo.codproductos.grupo='Dispositivo Medico'
group by consumo.codproductos.codigo1, consumo.codproductos.nombreprod1, consumo.codproductos.presentacion, consumo.codproductos.unidadmedida, consumo.codproductos.riesgo,lote, vence, 
consumo.lotes.laboratorio, consumo.lotes.reginvima, consumo.lotes.presentacion, consumo.lotes.cantidad, consumo.lotes.salidas, consumo.cumsxproducto.cum 
