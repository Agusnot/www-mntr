...
<title>Medicamentos Ordenados y Despachados</title>
<style type="text/css">
<!--
body,td,th {
...
<form id="FORMA" name="FORMA" method="post" action="">
  <div align="center">
    <table width="200" border="1" cellpadding="5" bordercolor="#EEEEEE" background="../Imgs/Fondo.jpg" bgcolor="#FFFFFF">
      <tr>
        <td colspan="12" nowrap="nowrap"><table width="200" align="left" cellpadding="5">
          <tr>
            <td colspan="2" nowrap="nowrap"><div align="left">
              <p><strong>MEDICAMENTOS ORDENADOS Y DESPACHADOS</strong></p>
              </div></td>
            </tr>
          <tr>
          ...
          <tr>
            ...
            <td nowrap="nowrap" bgcolor="#DDDDDD"><div align="left"><strong>PABELL&Oacute;N</strong></div></td>
            </tr>
          <tr>
      ...
      <tr>
        ...
        <td nowrap="nowrap" bgcolor="#EEEEEE"><strong>C&Oacute;DIGO PRODUCTO  </strong></td>
        ...
        <td nowrap="nowrap" bgcolor="#EEEEEE"><strong>FECHA INICIAL </strong></td>
        <td nowrap="nowrap" bgcolor="#EEEEEE"><strong>FECHA DESPACHO </strong></td>
        <td nowrap="nowrap" bgcolor="#EEEEEE"><strong>FECHA REGISTRO </strong></td>
        <td nowrap="nowrap" bgcolor="#EEEEEE"><strong>HORA</strong></td>
        <td nowrap="nowrap" bgcolor="#EEEEEE"><strong>CANTIDAD ORDENADA </strong></td>
        <td nowrap="nowrap" bgcolor="#EEEEEE"><strong>CANTIDAD DESPACHADA </strong></td>
        <td nowrap="nowrap" bgcolor="#EEEEEE"><strong>POSOLOG&Iacute;A</strong></td>
      </tr>
	   <tr>
	     <td>&nbsp;</td>
        <td>&nbsp;</td>
	   ...
	   <?php
 $cons="SELECT
	salud.plantillamedicamentos.autoidprod,
	salud.plantillamedicamentos.detalle,
	salud.plantillamedicamentos.cedpaciente,
	central.terceros.primape,
	central.terceros.segape,
	central.terceros.primnom,
	central.terceros.segnom,
	salud.plantillamedicamentos.fechaini,
	consumo.movimiento.fechadespacho,
	salud.registromedicamentos.fechacre as fecharegistro,
	salud.registromedicamentos.hora,
	salud.plantillamedicamentos.cantdiaria as cantidad_ordenada,
	consumo.movimiento.cantidad as cantidad_despachada,
	salud.registromedicamentos.cantidad as cantidad_registrada,
	salud.plantillamedicamentos.posologia
FROM
	salud.plantillamedicamentos
INNER JOIN
	central.terceros
	ON central.terceros.identificacion=salud.plantillamedicamentos.cedpaciente
INNER JOIN consumo.movimiento
	ON salud.plantillamedicamentos.cedpaciente=consumo.movimiento.cedula
	AND salud.plantillamedicamentos.autoidprod=consumo.movimiento.autoid
INNER JOIN salud.registromedicamentos
	ON salud.plantillamedicamentos.cedpaciente=salud.registromedicamentos.cedula
	AND salud.plantillamedicamentos.autoidprod=salud.registromedicamentos.autoid
WHERE
	fechafin IS NULL
	AND tipomedicamento = 'Medicamento Programado'
	AND salud.plantillamedicamentos.estado = 'AC'
	AND salud.plantillamedicamentos.fechaini<=consumo.movimiento.fechadespacho
	AND consumo.movimiento.fecha>= '$FechaIni'
	AND consumo.movimiento.fecha<= '$FechaFin'
	AND salud.registromedicamentos.fechacre>='$FechaIni'
	AND salud.registromedicamentos.fechacre<='$FechaFin'
ORDER BY
    central.terceros.primape";
echo $cons;
$res=ExQuery($cons);
...
echo'<tr>
        ...
        <td height="10">'.'$fila[3] $fila[4] $fila[5] $fila[6]'.'</td>
