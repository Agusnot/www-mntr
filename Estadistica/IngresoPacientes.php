...
<form id="FORMA" name="FORMA" method="post" action="">
  <div align="center">
    <table width="200" border="1" cellpadding="5" bordercolor="#EEEEEE" background="../Imgs/Fondo.jpg" bgcolor="#FFFFFF">
        ...
        <td colspan="8" nowrap="nowrap"><table width="200" align="left" cellpadding="5">
          <tr>
            <td nowrap="nowrap"><div align="left">
              <p><strong>INGRESO DE PACIENTES </strong></p>
              </div></td>
            </tr>
          <tr>
      ...
      <tr>
        ...
        <td nowrap="nowrap" bgcolor="#EEEEEE"><strong>DETALLE INGRESO PACIENTE</strong></td>
	   ...
	   <?php
 $cons="SELECT salud.servicios.cedula, central.terceros.primape, central.terceros.segape, central.terceros.primnom, central.terceros.segnom,salud.servicios.fechaing,salud.ordenesmedicas.detalle, salud.servicios.autorizac1, salud.servicios.usuarioingreso, central.usuarios.nombre
 ...
 INNER JOIN central.usuarios on salud.servicios.usuarioingreso=central.usuarios.usuario
 WHERE salud.servicios.fechaing  BETWEEN '$FechaIni 00:00:00' AND '$FechaFin 23:59:59'
 AND salud.servicios.tiposervicio = 'Hospitalizacion'
 AND salud.ordenesmedicas.tipoorden='Ingreso'
 ORDER BY salud.servicios.fechaing";
//echo $cons;
$res=ExQuery($cons);
$ln=1;
...
echo'<tr>
        ...
        <td nowrap="nowrap" height="10">'.$fila[9].'</td>
		<td height="10">'.$eps.'</td>
      </tr>';
	  $ln++;
	  }
