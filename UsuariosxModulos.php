			...
			<head>
				...
				<body>
						<form method="post" name="FORMA" onSubmit="return Validar()">
							<table  rules="groups" class="Tabla2"  <?php echo $borderTabla2Mentor; echo $bordercolorTabla2Mentor; echo $cellspacingTabla2Mentor; echo $cellpaddingTabla2Mentor; ?>>
								<tr>
									<td class="encabezado2VerticalInvertido">SELECCIONE UN ROL:</td>
									<td>
								...
								<tr>	
									<td class="encabezado2VerticalInvertido" style="font-size:12px;">NOMBRE NUEVO ROL:</td>
									<td>
										<input type="text" name="NewRol" id="NewRol"maxlenght="20" style="width:80px;" onKeyUp="Validar(this.value)" />
										<button type="submit" name="NuevoRol" value="?" class="boton1Envio" onclick="alert('Para crear un nuevo ROL asignele una descripcion en este campo, seleccione los permisos que va a tener y de clic en el boton Guardar al final de este formulario ')" > ? </button>
								...
								<tr>
									<td  class="encabezado2VerticalInvertido" style="font-size:12px;">COMPA&Ntilde;IA</td>
									<td>
										<select name="CompaniaSel" style="width:200px;" onChange="document.FORMA.submit();">
											<?
								...
								<table class="Tabla2"  <?php echo $borderTabla2Mentor; echo $bordercolorTabla2Mentor; echo $cellspacingTabla2Mentor; echo $cellpaddingTabla2Mentor; ?>>
									...
									<tr>
										<td class="encabezado2VerticalInvertido" style="font-size:12px;" >USUARIO: <? echo $Usuario?></td>
										<td><input type="checkbox" name="Marcacion" onClick="Marcar()"></td>
									</tr>
						<?
							//---
							if($Rol)
						...
						//		if($MatMadrexRol[$fila[0]]){$Check1="checked";}else{$Check1="";}
								?>
								<tr>
									<td class="encabezado2Horizontal"><? echo $fila[0] ?></td>
									<td><input name="Option[<? echo "$Madre_$fila[0]" ?>]" <? echo $Check1 ?> type='checkbox' onClick="MarcarHijos('<? echo $fila[0]?>',this.checked)"></td></tr>
						<?
								$cons1="Select Perfil,Madre from Central.AccesoxModulos where AccesoxModulos.Madre='$fila[0]' and ModuloGr='$fila[0]'  and ind_estado = '0' Order By Id";
								$res1=ExQuery($cons1);
								while($fila1=ExFetch($res1))
								{
									$consV2="Select * from Central.$TablaBusq where $CampoBusq='$VariableBusq' and UPPER(Modulo) = '$fila1[0]' and UPPER(Madre) = '$fila[0]' $CondAdic1";
						...
						<?
									...
									where AccesoxModulos.Madre='$fila1[0]' and ModuloGr='$fila[0]' and ind_estado = '0' Order By Id";
									$res2=ExQuery($cons2);
						...
						<?
										...
										where AccesoxModulos.Madre='$fila2[0]' and ModuloGr='$fila[0]'  and ind_estado = '0' Order By Id";
										$res3=ExQuery($cons3);
