...
<div id="responseGlosseTabs" <?=$Data->getParameter("GUI");?> class="ui-state-highlight ui-corner-all">
	<ul class="ui-state-default ui-corner-all">
		<li><a href="#responseGlosseTab-1">RESPUESTA DE GLOSAS</a></li>
		<li><a href="#responseGlosseTab-2">PROCESAR RESPUESTA GLOSA</a></li>
	</ul>
	<div id="responseGlosseTab-1">
	     <table width="100%" align="center">  
         <tr>
             <td><form id="responseGlosses">
                 <table width="100%">
                    <tr>	
					...
					<tr align="center"> 
        		           <td class="ui-state-default" colspan="2"><a href="#" id="fillingResponseGlossesView" class="ui-button ui-state-default ui-corner-all ui-button-text-only" role="button" aria-disabled="false" onClick="Filing.responseGlossesView(true);"><span class="ui-button-text" >Ver</span></a></td>
         	        </tr>
         	       </table>
              ...
              <tr>
                <td colspan="2">
                 <div id="responseGlossesView"></div>   	    
                </td>
              </tr>			  
     </table>
	</div>
	<div id="responseGlosseTab-2">
	   <div id="makeResponseGlossesView"></div>	
	</div>
</div>
</td></tr></table>
</body>
...
<script language="javascript">Utility.tab("responseGlosseTabs");Utility.tabDisabled("responseGlosseTabs",1);</script>