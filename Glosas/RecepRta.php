...
<div id="receivingResponseGlosseTabs" <?=$Data->getParameter("GUI");?> class="ui-state-highlight ui-corner-all">
	<ul class="ui-state-default ui-corner-all">
		<li><a href="#receivingResponseGlosseTab-1">RECEPCI&Oacute;N DE RESPUESTAS</a></li>
		<li><a href="#receivingResponseGlosseTab-2">PROCESAR RECEPCI&Oacute;N DE RESPUESTA</a></li>
	</ul>
	<div id="receivingResponseGlosseTab-1">
	     <table width="100%" align="center">  
         <tr>
             <td><form id="receivingResponseGlosses">
                 <table width="100%" class="ui-corner-all">
					...
					<tr align="center"> 
        		           <td class="ui-state-default" colspan="2"><a href="#" id="fillingReceivingResponseGlossesView" class="ui-button ui-state-default ui-corner-all ui-button-text-only" role="button" aria-disabled="false" onClick="Filing.receivingResponseGlossesView(true);"><span class="ui-button-text" >Ver</span></a></td>
         	        </tr>
         	       </table>
              ...
              <tr>
                <td colspan="2">
                 <div id="receivingResponseGlossesView"></div>   	    
                </td>
              </tr>			  
     </table>
	</div>
	<div id="receivingResponseGlosseTab-2">
	   <div id="confirmMakeReceivingResponseGlosses"></div>	
	</div>
</div>
</td></tr></table>
</body>
...
<script language="javascript">Utility.tab("receivingResponseGlosseTabs");Utility.tabDisabled("receivingResponseGlosseTabs",1);</script>