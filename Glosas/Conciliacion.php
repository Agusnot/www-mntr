...
<div id="conciliationGlosseTabs" <?=$Data->getParameter("GUI");?> class="ui-state-highlight ui-corner-all">
	<ul class="ui-state-default ui-corner-all">
		<li><a href="#conciliationGlosseTab-1">CONCILIACI&Oacute;N</a></li>
		<li><a href="#conciliationGlosseTab-2">PROCESAR CONCILIACI&Oacute;N</a></li>
	</ul>
	<div id="conciliationGlosseTab-1">
	     <table width="100%" align="center">  
         <tr>
             <td><form id="conciliationGlosses">
                 <table width="100%" class="ui-corner-all">
					...
					<tr align="center"> 
        		           <td class="ui-state-default" colspan="2"><a href="#" id="fillingReceivingResponseGlossesView" class="ui-button ui-state-default ui-corner-all ui-button-text-only" role="button" aria-disabled="false" onClick="Filing.conciliationGlossesView(true);"><span class="ui-button-text" >Ver</span></a></td>
         	        </tr>
         	       </table>
              ...
              <tr>
                <td colspan="2">
                 <div id="conciliationGlossesView"></div>   	    
                </td>
              </tr>			  
     </table>
	</div>
	<div id="conciliationGlosseTab-2">
	   <div id="confirmMakeConciliationGlosses"></div>	
	</div>
</div>
</td></tr></table>
</body>
...
<script language="javascript">Utility.tab("conciliationGlosseTabs");Utility.tabDisabled("conciliationGlosseTabs",1);</script>