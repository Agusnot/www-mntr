<?
	...
	$cons="select firmasrtaglosas.usuario,usuarios.nombre,usuarios.cedula ,firmadocumento
	from facturacion.firmasrtaglosas,central.usuarios
	 where compania='$Compania[0]' AND firmasrtaglosas.usuario= usuarios.usuario order by firmasrtaglosas.usuario ";
	$res=ExQuery($cons);
?>
<html>
<head>
...
<?	while($fila=ExFetch($res)){?>
		<tr onMouseOver="this.bgColor='#AAD4FF'" onMouseOut="this.bgColor=''"> 
            ...
            <td>
			<?
			if($fila[3]=="SI") {  echo "<img src='../Imgs/b_check.png'>"; }
			             else  {  echo "-"; }			
			?>						
			</td>
            <td>
