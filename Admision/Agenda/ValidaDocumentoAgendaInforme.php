...
<?
	...
	{?>
        <script language="javascript">
			parent.document.FORMA.Cedula.value="<? echo $CedDef?>";						
			//parent.document.FORMA.submit();
			CerrarThis();
		</script>
<?	}
...
if($Cedula){
	...
	while($fila=ExFetch($res))
	{
		...
		<?	}
        		...
        		onClick="location.href='ValidaDocumentoAgendaInforme.php?DatNameSID=<? echo $DatNameSID?>&Multa=<? echo $Multa?>&CedDef=<? echo $fila[0]?>&Cedula=<? echo $Cedula?>'"
       	<?	}?>
        >
        	<td><? echo $fila[0]?></td>
