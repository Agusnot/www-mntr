<?
	...
	$cons="select nombre from central.usuarios where usuario='$Medico'";
	$res=ExQuery($cons);
	$fila=ExFetch($res);	
...
<tr><td colspan="11"><center><strong><? echo strtoupper($Compania[0])?><br>
		<? echo $Compania[1]?><br>AGENDA POR MEDICO<br></td></tr>
	<tr>
...
<tr><td bgcolor="#e5e5e5" style="font-weight:bold" align="center" colspan="6"><? echo "$fila[0]-$Especialidad";?></td></tr>
...
terceros.identificacion=agenda.cedula and medico='$Medico' and fecha='$Fecha' and estado='Pendiente' and agenda.compania='$Compania[0]' and terceros.compania='$Compania[0]' order by hrsini,minsini";
