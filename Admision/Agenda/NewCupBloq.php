      	...
      	<?	while($fila=ExFetch($res))
			{?>
                ...
                onclick="if(confirm('¿Esta seguro de agregar esta restriccion?')){
               		parent.location.href='CupBloqueo.php?DatNameSID=<? echo $DatNameSID?>&Codigo=<? echo $Codigo?>&Nombre=<? echo $Nombre?>&Especialidad=<? echo $Especialidad?>&Profecional=<? echo $Profecional?>&Fecha=<? echo $Fecha?>&Agregar=<? echo $fila[0]?>&HoraIni=<? echo $HoraIni?>&MinIni=<? echo $MinIni?>';}">
