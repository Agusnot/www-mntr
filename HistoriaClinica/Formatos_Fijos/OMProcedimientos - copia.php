				...
				//if($Suministro=="Externo"){
					...
					$res = ExQuery($cons);
                                        ...
                                        $consulta="INSERT INTO histoclinicafrms.tbl00004 "
                                                ...
                                                . "VALUES ( '".$fila2['ambitoreal']."', '".$usuario[3]."', '".$fila2['causaexterna']."', '".$fila2['cedula']."', NULL, '', '', '', '', '".$fila2['detalle']."', '".$fila2['compania']."', '".$fila2['diagnostico']."', '', NULL, NULL, NULL, '".$fila2['fechaini']."', NULL, '', 'NOTAS EVOLUCION', '$ND[hours]:$ND[minutes]:$ND[seconds]', '".$filaih['id_historia']."', NULL, NULL, '".$fila2['numprocedimiento']."', '".$fila2['numservicio']."', '', '', '".$fila2['tipodx']."', 'HISTORIA CLINICA', '".$Unidad."', '".$fila2['usuario']."', '' );";
