				...
				//if($Suministro=="Externo"){
					...
					if($Unidad==""){
						$consulta="INSERT INTO histoclinicafrms.tbl00004 "
							...
							. "VALUES ( '".$fila2['ambitoreal']."', '".$usuario[3]."', '".$fila2['causaexterna']."', '".$fila2['cedula']."', NULL, '', '".$fila2['detalle']." Justificacion ".$fila2['justificacion']." $textonota ".$fila2['observaciones']."', '', '', '".$fila2['compania']."', '".$fila2['diagnostico']."', '', NULL, NULL, NULL, '".$fila2['fechaini']."', NULL, '', 'NOTAS EVOLUCION', '$ND[hours]:$ND[minutes]:$ND[seconds]', '".$filaih['id_historia']."', NULL, NULL, '".$fila2['numprocedimiento']."', '".$fila2['numservicio']."', '', '', '".$fila2['tipodx']."', 'HISTORIA CLINICA', NULL, '".$fila2['usuario']."', '' );";
					}
					else{
						$consulta="INSERT INTO histoclinicafrms.tbl00004 "
							. "(ambito, cargo, causaexterna, cedula, cerrado, cmp00003, cmp00005, cmp00007, cmp00009, compania, dx1, dx2, dx3, dx4, dx5, fecha, fechaajuste, finalidadconsult, formato, hora, id_historia, id_historia_origen, noliquidacion, numproced, numservicio, padreformato, padretipoformato, tipodx, tipoformato, unidadhosp, usuario, usuarioajuste) "
							. "VALUES ( '".$fila2['ambitoreal']."', '".$usuario[3]."', '".$fila2['causaexterna']."', '".$fila2['cedula']."', NULL, '', '".$fila2['detalle']." Justificacion ".$fila2['justificacion']." $textonota ".$fila2['observaciones']."', '', '', '".$fila2['compania']."', '".$fila2['diagnostico']."', '', NULL, NULL, NULL, '".$fila2['fechaini']."', NULL, '', 'NOTAS EVOLUCION', '$ND[hours]:$ND[minutes]:$ND[seconds]', '".$filaih['id_historia']."', NULL, NULL, '".$fila2['numprocedimiento']."', '".$fila2['numservicio']."', '', '', '".$fila2['tipodx']."', 'HISTORIA CLINICA', '".$Unidad."', '".$fila2['usuario']."', '' );";
					}
...
<div style="width:100px;">
                              <a class="button" href="#" onclick="AbrirProcedimientos()">
                                    <span>
                                            <span>
                                                    <span>
                                                            <span>Escoger Procedimiento</span>
                                                    </span>
                                            </span>
                                    </span>
                              </a>
    ...
    <tr>
        <?php            
            if(!$CodDiagnostico1){
				...
				$cons0004="select dx1 from histoclinicafrms.tbl00004 where numservicio=$filap[1] and cedula='$Paciente[1]' and cargo='PSIQUIATRA' ORDER BY fecha,hora desc limit 1";
