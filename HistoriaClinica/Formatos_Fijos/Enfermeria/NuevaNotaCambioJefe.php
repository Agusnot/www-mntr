<?php
	...
	if($Guardar)
	{
		$cons = "Insert Into HistoriaClinica.NotasCambioJefe (Compania,Fecha,Usuario,Nota,Unidad) 
		Values('$Compania[0]','$Anio-$Mes-$Dia $Horas:$Minutos:$Segundos','$usuario[0]','$Anotacion','$SelUnidad')";
		$res = ExQuery($cons);
		?><script language='JavaScript'>location.href='NotasCambioJefe.php?DatNameSID=<? echo $DatNameSID?>&SelUnidad=<? echo $SelUnidad?>';</script>
		<?
	}
?>
<head>
...
<td align="center">NUEVA NOTA DE CAMBIO DE JEFE</td>
</tr>	
...
<input type="Button" name="Cancelar" value="Cancelar" onClick="location.href='NotasCambioJefe.php?DatNameSID=<? echo $DatNameSID?>&SelUnidad=<? echo $SelUnidad?>'">
</center>
</form>
</body>
