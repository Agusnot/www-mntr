...
<input type="hidden" name="Formulacion" value="<? echo $Formulacion?>" />
	<table border="1" bordercolor="#e5e5e5" width="80%" align="center" style='font : normal normal small-caps 13px Tahoma;'>
        ...
        <tr>
            ...
            onkeyup="xLetra(this);frames.BusqMedicamentos.location.href='BusqAmpollas.php?DatNameSID=<? echo $DatNameSID?>&Formulacion=<? echo $Formulacion?>&AlmacenPpal='+
            ...
            onFocus="frames.BusqMedicamentos.location.href='BusqAmpollas.php?DatNameSID=<? echo $DatNameSID?>&Formulacion=<? echo $Formulacion?>&AlmacenPpal='+FORMA.AlmacenPpal.value+'&Codigo='+FORMA.Codigo.value+'&Medicamento='+this.value+'&Paquete=<?echo $Paquete?>&Entidad=<?echo $Entidad?>&Contrato=<?echo $Contrato?>&NoContrato=<?echo $NoContrato?>;" onKeyDown="xLetra(this)" /></td>
        </tr>
    </table>
    <input type="hidden" name="DatNameSID" value="<? echo $DatNameSID?>">
</form>
<iframe id="BusqMedicamentos" name="BusqMedicamentos" frameborder="0" width="100%" height="75%" src="BusqAmpollas.php?DatNameSID=<? echo $DatNameSID?>"></iframe>
</body>