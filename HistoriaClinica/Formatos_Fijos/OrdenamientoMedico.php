...
if($Paciente[1]&&$Paciente[21]){
		...
		<?	}
			...
			{	
				...
				<?php	$cont=1;
					...
					{
						$consNota="select notas,justificacion from salud.plantillamedicamentos where numservicio='$Ordens[1]' and idescritura='$Ordens[13]' and fechaformula='$Ordens[8]' and numorden='$Ordens[2]'";
						$resNota=ExQuery($consNota);
						$filaNota=ExFetch($resNota);
                                                //$consJu="select justificacion from salud.plantillanotas where numservicio='$Ordens[1]' and idescritura='$Ordens[13]' and fechaini='$Ordens[8]'";
                        ...
                        <tr>
                            ...
                            <td><?php
								if($filaNota2[0]){
                                        echo "$Ordens[0] $filaNota[0] $Ordens[15] $Ordens[14] "; 
                                        if($Ordens[4]){ 
                                            echo " Via $Ordens[4] ";
                                        } 										
                                }else{
                                        echo "$Ordens[0] $Ordens[3] $Ordens[15] $Ordens[14] "; 
                                        if($Ordens[4]){ 
                                            echo " Via $Ordens[4] ";
                                        }
                                        ...
                                        if($Ordens[5]=='Medicamento Programado' || $Ordens[5]=='Medicamento Urgente'){
                                            if($filaNota[0]){
                                        ...
                                        if($Ordens[5]=='Nota'){
                                            $consJu="select justificacion from salud.plantillanotas where numservicio='$Ordens[1]' and idescritura='$Ordens[13]' and fechaini='$Ordens[8]' and numorden='$Ordens[2]'";
                                            $resJu=ExQuery($consJu);
                                            $filaJu=ExFetch($resJu);
                                        ...
                                        if($Ordens[5]=='Procedimiento'){
                                            $consProc="select observaciones,justificacion from salud.plantillaprocedimientos where numservicio='$Ordens[1]' and idescritura='$Ordens[13]' and numorden='$Ordens[2]'";
		...
		$cons="select numservicio,tiposervicio,fechaing,fechaegr from salud.servicios where compania='$Compania[0]' and cedula='$Paciente[1]' order by numservicio desc";
			...
			{			
				...
				<?	$cons="select idescritura,substring(cast(fecha as text),1,10) from salud.ordenesmedicas 
					...
					<?php	$cons3="select ordenesmedicas.detalle,ordenesmedicas.numservicio,ordenesmedicas.numorden,posologia,viasumin,tipoorden,fechareprog,substring(cast(fecha as text),1,10),observacionDieta,
						...
						while($fila3=ExFetch($res3))
						{
							$consNota="select notas,justificacion from salud.plantillamedicamentos where numservicio='$fila3[1]' and idescritura='$fila3[10]' and fechaformula='$fila3[11]' and numorden='$fila3[2]'";
							$resNota=ExQuery($consNota);
							$filaNota=ExFetch($resNota);
                                                        //$consJu="select justificacion from salud.plantillanotas where numservicio='$fila3[1]' and idescritura='$fila3[10]' and fechaini='$fila3[11]'";
                                                        //$resJu=ExQuery($consJu);
                                                        //$filaJu=ExFetch($resJu);
							...
							<tr>
                                ...
                                <td><?php
									if($filaNota2[0]){
                                                ...
                                                // Para imprimir las notas y justificacion
                                                if($fila3[5]=='Medicamento Programado' || $fila3[5]=='Medicamento Urgente'){
                                                    if($filaNota[0]){
                                                        echo " <i>Nota:</i> ".$filaNota[0]." ";
                                                    }
                                                    if($filaNota[1]){
                                                ...
                                                if($fila3[5]=='Nota'){
                                                    $consJu="select justificacion from salud.plantillanotas where numservicio='$fila3[1]' and idescritura='$fila3[10]' and fechaini='$fila3[11]' and numorden='$fila3[2]'";
                                                    $resJu=ExQuery($consJu);
                                                    $filaJu=ExFetch($resJu);
                                                ...
                                                if($fila3[5]=='Procedimiento'){
                                                    $consProc="select observaciones,justificacion from salud.plantillaprocedimientos where numservicio='$fila3[1]' and idescritura='$fila3[10]' and numorden='$fila3[2]'";
                                                    $resProc=ExQuery($consProc);
                                                    $filaProc=ExFetch($resProc);
	...
	<?		}
		...
		<?	$cons3="select ordenesmedicas.detalle,ordenesmedicas.numservicio,ordenesmedicas.numorden,posologia,viasumin,tipoorden,fechareprog,observacionDieta, 
			...
			while($fila3=ExFetch($res3))
			{
				$consNota="select notas,justificacion from salud.plantillamedicamentos where numservicio='$fila3[1]' and idescritura='$fila3[9]' and numorden='$fila3[2]'";
				$resNota=ExQuery($consNota);
				$filaNota=ExFetch($resNota);
                                $consJu="select justificacion from salud.plantillanotas where numservicio='$fila3[1]' and idescritura='$fila3[9]' and fechaini='$fila3[10]'";
                                $resJu=ExQuery($consJu);
                                $filaJu=ExFetch($resJu);
