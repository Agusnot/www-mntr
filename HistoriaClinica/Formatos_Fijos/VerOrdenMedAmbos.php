...
and (tipoorden='Medicamento Urgente' or tipoorden='Medicamento Programado' or tipoorden='Medicamento No Programado' or tipoorden='Procedimiento') order by fecha,tipoorden";	
$res=ExQuery($cons);
//echo $cons;
