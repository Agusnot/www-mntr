...
<?
if($EntidadUrg&&$ContratoUrg&&$NoContratoUrg)
{?>
...
<tr>
	...
	<td colspan="3"><select name="Triage">
	<?	$cons="Select triage,prioridad from Salud.Triage where compania='$Compania[0]' order by triage";
        $res=ExQuery($cons);
