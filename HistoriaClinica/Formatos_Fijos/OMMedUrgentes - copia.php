		...
		if(!$Editar)
		{
            ...
            if(!$Paquete)
            {
                ...
                $consulta="INSERT INTO histoclinicafrms.tbl00004 "
                  ...
                  . "VALUES ( '".$fila5['tiposervicio']."', '".$usuario[3]."', NULL, '".$fila['cedpaciente']."', NULL, '', '', '', '', '".$fila['detalle']." ".$fila['posologia']." Vía ".$fila['viasuministro']." Justificación ".$fila['justificacion']." Nota ".$fila['notas']."', '".$fila['compania']."', NULL, NULL, NULL, NULL, NULL, '$ND[year]-$ND[mon]-$ND[mday]', NULL, '', 'NOTAS EVOLUCION', '$ND[hours]:$ND[minutes]:$ND[seconds]', '".$filaih['id_historia']."', NULL, NULL, NULL, '".$fila['numservicio']."', '', '', NULL, 'HISTORIA CLINICA', '".$Unidad."', '".$fila['usuario']."', '' );";
