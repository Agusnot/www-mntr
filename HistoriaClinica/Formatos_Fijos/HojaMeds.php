<?
    ...
    if($Medicamento){$Adcons = "and NoRegistroMedicamentos.Autoid=$Medicamento ";}
    ...
    $cons = "Select RegistroMedicamentos.Autoid,date(RegistroMedicamentos.FechaCre),Hora,Tipo,Cantidad,Nombre,
