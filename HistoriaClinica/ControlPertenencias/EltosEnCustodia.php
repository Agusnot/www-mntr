<?php
	...
	$cons="select responsable,elemento,estado,fechasalida,nota,nc,cantidad from salud.elementoscustodia where compania='$Compania[0]' and cedula='$Ced' and numservicio=$NumServ and 
...
<table style='font : normal normal small-caps 12px Tahoma;' align="center" cellpadding="4">
    ...
    <tr>
        <td align="center" style="font-weight:bold">Proceso</td>
...
<table bordercolor="#e5e5e5" border="1" style='font : normal normal small-caps 12px Tahoma;' align="center" cellpadding="4">
	<tr><td align="center"  bgcolor="#e5e5e5" style="font-weight:bold" colspan="15">Elementos En Custodia</td></tr>
	<tr align="center"  bgcolor="#e5e5e5" style="font-weight:bold">
		<td>Responsalbe</td><td>Elemento</td><td>Estado</td><td>Nota</td><td>No Conformidad</td>
  	</tr>
<?	if(ExNumRows($res)>0)
	{
		while($fila=ExFetch($res))
		{
			...
			?>
            <tr align="center">            
				<td><? echo $Usus[$fila[0]]?></td><td><? echo $fila[1]?></td><td><? echo $fila[2]?></td>
