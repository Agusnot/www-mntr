...
<script language="javascript">
	...
	{		
		frames.FrameOpener3.location.href="ValidaDiagnostico.php?DatNameSID=<? echo $DatNameSID?>&Codigo="+Objeto1.value+"&Nombre="+Objeto2.value+"&NameCod="+NameCod+"&NameNom="+NameNom;
		...
		document.getElementById('FrameOpener3').style.height='150px';
	}
</script>	
<?
if($CodDx){?>
