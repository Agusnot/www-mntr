...
?><body background="/Imgs/Fondo.jpg"></body>
...
if($UnidadIraLista){$Pabellon=$UnidadIraLista;$Buscar=1;}
	if($Buscar){
		...
		{			
			...
			{
				$Paciente="";
				echo "<br><br><a target='_top' href='/HistoriaClinica/HistoriaClinica.php?DatNameSID=$DatNameSID&cedula=$Cedula'>Crear Registro</a>";
			}
		}
		...
		elseif(ExNumRows($resultado)>1)
		{
			...
			echo "<table width='100%' border='1' cellspacing='0' style='font : normal normal small-caps 11px Tahoma;'>";
			echo "<tr   bgcolor='#e5e5e5' style='font-weight:bold;'><td colspan='2'>Usuarios Encontrados (".ExNumRows($resultado).")</td></tr>";
