...
<form name="FORMA" method="post" action="ContControlLiquidos.php" target="ContenidoCL">
...
<form name="FORMA1" method="post" action="OpcionesControlLiquidos.php" target="OpcionesCL">
<input type="hidden" name="DatNameSID" value="<? echo $DatNameSID?>" />
<input type="hidden" name="NumServicio" value="<? echo $NumServicio?>" />
