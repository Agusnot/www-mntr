...
<div style="font-size:12px; padding-top:5px; color:#CCCCCC; font-family:Tahoma, Geneva, sans-serif;"><img src="/Imgs/3.png" style="float:left; width: 18px; padding-left: 20px; padding-right: 5px;">USUARIO: <span style="color:#FFFFFF; font-weight:bold;"><?php echo $usuario[0];?></span>
</div>
...
<?	if($Pacie){$Paciente[1]=$Pacie;
	...
	$cons0004="select dx1
	from histoclinicafrms.tbl00004 where numservicio=$fila[1] and cedula='$Paciente[1]' ORDER BY fecha desc limit 1";
...
<?		$ban=0;
	...
	if($Ambito!=''){
		...
		if ($DiasEstancia>=10 && $Ambito!='Consulta Externa' && $Ambito!='Hospital Dia'&& $medtratante!='lestancia'){ echo '<SCRIPT>	javascript:alert("ALERTA: Paciente con 10 Dias o Mas de Estancia,     \nPor Favor Realizar Comite Tecnico Cientifico. ");</SCRIPT>';}
