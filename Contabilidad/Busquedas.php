	...
	<html>
		...
		<div align="center">
			<table height="100%" width="100%" class="tabla2"  <?php echo $borderTabla2Mentor; echo $bordercolorTabla2Mentor; echo $cellspacingTabla2Mentor; echo $cellpaddingTabla2Mentor; ?>>
				<tr>
					<td class="encabezado2Horizontal" style="height:10px;" >ASISTENTE DE B&Uacute;SQUEDA</td>
				</tr>
				<tr>
					<td <? if($Reporteador){?> valign="top"<?}?>>
						<?
							if(!$Tipo)	{
