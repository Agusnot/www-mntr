	...
	<html>
		...
		<body>
			...
			<div align="center">
					...
					<table  width="100%" class="tabla2" style="font-size:12px"  <?php echo $borderTabla2Mentor ; echo $bordercolorTabla2Mentor ; echo $cellspacingTabla2Mentor ; echo $cellpaddingTabla2Mentor; ?>>
						<tr>
							<td class="encabezado2Horizontal" style="font-size:12px;">BASE GRAVABLE</td>
							<td colspan="4">
						...
						<tr>
							<td class="encabezado2Horizontal" style="font-size:12px;">&nbsp;</td>
							<td class="encabezado2Horizontal" style="font-size:12px;">CONCEPTO</td>
							<td class="encabezado2Horizontal" style="font-size:12px;">PORCENTAJE</td>
							<td class="encabezado2Horizontal" style="font-size:12px;">IVA</td>
							<td class="encabezado2Horizontal" style="font-size:12px;">BASE</td>
						</tr>
					<?
						...
						{
							echo "<tr><td colspan=5 class='encabezado2HorizontalInv' style='font-size:12px;background-color:#E5E5E5;text-align:center;'>$fila1[0] </td></tr>";
					...
					<input type="Submit" class="boton2Envio" name="Guardar" value="Registrar">
