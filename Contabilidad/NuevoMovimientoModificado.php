						...
						<tr>
							<td>
								<table width="700px" class="tabla2"  <?php echo $borderTabla2Mentor ; echo $bordercolorTabla2Mentor ; echo $cellspacingTabla2Mentor ; echo $cellpaddingTabla2Mentor; ?>>
									<tr>
										<td class="encabezado2Horizontal" colspan="6"><?echo strtoupper($Comprobante)?></td>
									</tr>
									<tr>
										...
										<td class="encabezado2VerticalInvertido">FECHA DOC.</td>
										<td>
									...
									<tr>
										...
										<td colspan="5" ><input type="Text" id="Detalle" onKeyPress="return evitarSubmit(event)"  onKeyUp="xLetra(this);" onKeyDown="xLetra(this)" value="<?echo $Detalle?>" name="Detalle" onfocus="Ocultar()" style="width:580px;" onblur="frames.NuevoMovimiento.document.FORMA.Detalle.value=this.value" onfocus="frames.NuevoMovimiento.document.FORMA.Tercero.value=Identificacion.value"></td>
									</tr>
									<tr>
										<td class="encabezado2Horizontal"  colspan="3">EGRESO</td>
										<td class="encabezado2Horizontal"  colspan="3">INGRESO</td>
									</tr>
									<tr>
										<td class="encabezado2VerticalInvertido">BANCO</td>
										<td>
