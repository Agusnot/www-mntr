	...
	<html>			
		...
		<body <?php echo $backgroundBodyMentor; ?>>	
				...
				$rutaarchivo[3] = "CONCEPTOS DE PAGO";					
			...
			<div align="left" style="margin-left:10px;">		
				<table class="tabla2"   <?php echo $borderTabla2Mentor; echo $bordercolorTabla2Mentor; echo $cellspacingTabla2Mentor; echo $cellpaddingTabla2Mentor; ?>>
						<tr>
							<td class='encabezado2HorizontalInvertido'>COMPROBANTE</td>
								<td class='encabezado2HorizontalInvertido'>
									<select name="Comprobante" onChange="location.href='ConfConceptosPago.php?DatNameSID=<? echo $DatNameSID?>&Comprobante='+Comprobante.value+'&Anio='+Anio.value">
										<option value="">&nbsp;</option>
										<?
					...
					<table class="tabla2"  style="margin-top:25px;"  <?php echo $borderTabla2Mentor; echo $bordercolorTabla2Mentor; echo $cellspacingTabla2Mentor; echo $cellpaddingTabla2Mentor; ?>>
						<tr>
							<td class='encabezado2Horizontal'>CONCEPTO</td>
							<td class='encabezado2Horizontal'>CUENTA CR&Eacute;DITO</td>
							<td  class='encabezado2Horizontal'colspan="5">CUENTA D&Eacute;BITO</td>
						</tr>
						<?
