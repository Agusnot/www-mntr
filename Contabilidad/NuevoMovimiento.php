...
?>
	<html>
						...
						<tr>
							<td>
								<table width="700px" class="tabla2"  <?php echo $borderTabla2Mentor ; echo $bordercolorTabla2Mentor ; echo $cellspacingTabla2Mentor ; echo $cellpaddingTabla2Mentor; ?>>
									...
									<tr>
										<td class="encabezado2Horizontal" colspan="2">EGRESO</td>
										<td class="encabezado2Horizontal" colspan="2">INGRESO</td>
									</tr>
									<tr>
									...
									<table border="0"  width="100%" cellpadding="0" cellspacing="0" style="text-align: center;">
										<tr>
											<td class="encabezado2HorizontalInvertido" >PAGO EN</td>
											<td class="encabezado2HorizontalInvertido" >BANCO</td>
										</tr>										
										<tr>
											<td style="text-align: center;">
						...
						<tr>
							<td  colspan="2">
								<table border="0"  width="100%" cellpadding="0" cellspacing="0">
									<tr>
										<td class="encabezado2HorizontalInvertido" > TIPO DE PAGO </td>
										<td class="encabezado2HorizontalInvertido" > CLASE DE PAGO </td>
									</tr>
									<tr>
										<td style="text-align:center;">
							...
							<td class="encabezado2VerticalInvertido" colspan="2">
			...
			<input type="Submit" name="Guardar" class="boton2Envio" value="Guardar Registro" style="width:150px;" disabled>
			<input type="Submit" name="Cancelar" class="boton2Envio" value="Cancelar" style="width:150px;">
			<br>
			<?
			...
			?>
			<input type="submit" class="boton2Envio" onFocus="Ocultar()" value="Insertar registro en:" title="<? echo $NumeroAcarreo?>" name="Acarrear" style="width:150px;" disabled>
