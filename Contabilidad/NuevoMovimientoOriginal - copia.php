...
<html>
			...
			<body <?php echo $backgroundBodyMentor; ?> onLoad="document.FORMA.Tercero.focus();" onFocus="Ocultar()">
				<?php
					$rutaarchivo[0] = "CONTABILIDAD";
					$rutaarchivo[1] = "NUEVO DOCUMENTO";	
						if(!empty($_GET['Comprobante'])){
								$rutaarchivo[2] = $_GET['Comprobante'];
						}
						...
						<tr>
							<td>
								<table width="700px" class="tabla2"  <?php echo $borderTabla2Mentor ; echo $bordercolorTabla2Mentor ; echo $cellspacingTabla2Mentor ; echo $cellpaddingTabla2Mentor; ?>>
									<tr>
										<td class="encabezado2Horizontal" colspan="4"><?echo strtoupper($Comprobante)?></td>
									</tr>
									<tr>
										<td class="encabezado2VerticalInvertido" style="font-weight:normal;" >FECHA</td>
										<td class="encabezado2VerticalInvertido" style="font-weight:normal;" >
											...
											FECHA DOC
											<input type="Text" name="FechaDocumento" value="<? echo "$FechaDocumento"?>" style="width:70px;" maxlength="10" onKeyPress="return false;" onClick="popUpCalendar(this, FORMA.FechaDocumento, 'yyyy-mm-dd');">
										</td>
										<td class="encabezado2VerticalInvertido" style="font-weight:normal;"> N&Uacute;MERO</td>
										<td>
											<input type="Text" name="Numero" onFocus="Ocultar()" readonly="yes" style="width:170px;font-size:16px;color:blue;border:0px;font-weight:bold" value="<? if(($Edit==1)&&($Tipo="Entradas")){$consNC="select numero from contabilidad.movimiento where identificacion='$Identificacion' and detalle='$Detalle' and docsoporte='$NoFactura' limit 1";$resNC=ExQuery($consNC);while($filaNC=ExFetch($resNC)){$Numero=$filaNC[0];		}}echo $Numero?>">
										</td>
									</tr>
									<tr>
										<td class="encabezado2VerticalInvertido" style="font-weight:normal;"> TERCERO</td>
										<td>
											<input type="Text" name="Tercero" value="<? echo $Tercero?>" onKeyPress="return evitarSubmit(event)" style="width:250px;" onKeyUp="Mostrar();Identificacion.value='';frames.Busquedas.location.href='Busquedas.php?DatNameSID=<? echo $DatNameSID?>&Tipo=Nombre&Nombre='+this.value;Pasar(event,'Detalle')">
										</td>
										<td class="encabezado2VerticalInvertido" style="font-weight:normal;">IDENTIFICACI&Oacute;N</td>
										<td>
									...
									<tr>
										<td class="encabezado2VerticalInvertido" style="font-weight:normal;">DETALLE</td>
									...
									<tr>
										<td class="encabezado2Horizontal" style="font-weight:normal;" colspan="2">EGRESO</td>
										<td class="encabezado2Horizontal" style="font-weight:normal;" colspan="2">INGRESO</td>
									</tr>
									<tr>
										<td class="encabezado2VerticalInvertido" style="font-weight:normal;">BANCO</td>
										<td>
									...
									<table border="0"  width="100%" cellpadding="0" cellspacing="0" style="text-align: center;">
										<tr>
											<td class="encabezado2VerticalInvertido" style="text-align: center; font-weight:normal;">PAGO EN</td>
											<td class="encabezado2VerticalInvertido" style="text-align: center; font-weight:normal;">BANCO</td>
										</tr>										
										<tr>
											<td style="text-align: center;">
												<select name="PagoIngreso" <?echo $DisEgreso?> onFocus="Ocultar()">
													<?
											...
											<td style="text-align: center;">
												<input type="Text" onFocus="Ocultar()" name="IngBanco" style="width:70px;" <?echo $DisEgreso?>>
											</td>
										</tr>
									</table>	
								</td>
						...
						<tr>
							<td  colspan="2">
								<table border="0"  width="100%" cellpadding="0" cellspacing="0">
									<tr>
										<td class="encabezado2VerticalInvertido" style="text-align:center; font-weight:normal;"> TIPO DE PAGO </td>
										<td class="encabezado2VerticalInvertido" style="text-align:center; font-weight:normal;"> CLASE DE PAGO </td>
									</tr>
									<tr>
										<td style="text-align:center;">
							...
							<td style="text-align:center;" colspan="4">
								<?
									...
									if(ExNumRows($res)>0){
										...
										<input type="Button" class="boton2Envio" value="Afectar Documentos" onClick="AfectaDocumentos()" onFocus="Ocultar()" style="width:150px;">
										<?
									}
									?>
									...
									<input type="Button" <? echo $Disabled ?> accesskey="C" class="boton2Envio" value="Conceptos de pago" onFocus="Ocultar()" onClick="ConceptosPago()" style="width:150px;">
									...
									<input type="Button" onFocus="Ocultar()" class="boton2Envio" value="Retenciones" onClick="AplicaRetencion()" style="width:150px;">
									<?	}
									else
									{?>
										<input type="Button" onFocus="Ocultar()" class="boton2Envio" disabled value="Retenciones" onClick="AplicaRetencion()" style="width:150px;">
									<? } ?>
			...
			<iframe id="TotMovimientos" src="TotMovimientos.php?DatNameSID=<? echo $DatNameSID?>" frameborder="0" width="700" height="170px"></iframe><br>
