		...
		<body>
			<form name="FORMA" method="post" onSubmit="return Validar()">
				...
				<table width="100%" class="tabla2"   <?php echo $borderTabla2Mentor; echo $bordercolorTabla2Mentor; echo $cellspacingTabla2Mentor; echo $cellpaddingTabla2Mentor; ?> >
					<tr>
						<td class='encabezado2Horizontal' colspan="4" >CUENTA D&Eacute;BITO <? echo $Concepto?></td>
					</tr>
					<tr>
						<td class='encabezado2HorizontalInvertido'>CC</td>
						<td class='encabezado2HorizontalInvertido'>% DIST.</td>
						<td class='encabezado2HorizontalInvertido' colspan="2">CUENTA</td>
					</tr>
				<?
