...
<?php //REVISIÓN 001
	...
	if(ExNumRows($res2)==null)
	{
                ...
                echo "<font color='#ffffff'><br><center><img src='".$root."/Imgs/b_home.png'><img src='".$root."/Imgs/b_tblops.png' alt='Herramientas Administrativas'>";
...
<br>SELECCIONE APLICACIÓN:<br><br>
</font>
...
<div style="z-index: -9; background-color: #75c7ec; width: 305; height: 50px; position: absolute; top: 0px; right: 0px;"></div>
