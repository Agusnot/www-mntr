...
<form name="FORMA" method="post">
	<table border="1" bordercolor="#e5e5e5"  align="center" style='font : normal normal small-caps 13px Tahoma;'>    	
        ...
        <tr>
            ...
            onkeyup="xLetra(this);frames.BusqProcedimientos.location.href='BusqProcedimientos.php?DatNameSID=<? echo $DatNameSID?>&Codigo='+this.value+'&Nombre='+FORMA.Nombre.value;" onKeyDown="xLetra(this)"/></td>
